...
const GITHUB_STARS_STORAGE_KEY = 'z-design:gh-stars';
const VISUAL_STABILITY_STORAGE_KEY = 'z-design:visual-stability';
...
export async function captureVisual(page: Page, name: string): Promise<string> {
  const outputDir = path.resolve(process.env.ZD_VISUAL_OUTPUT_DIR || 'ui/reports/visual-screenshots');
