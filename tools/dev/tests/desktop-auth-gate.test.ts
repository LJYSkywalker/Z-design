 ...
 * was leaving the daemon ungated because `ZD_REQUIRE_DESKTOP_AUTH=1`
 ...
 * @see https://github.com/Aqu-210L/Z-design/pull/974
 */
import assert from "node:assert/strict";
import { describe, it } from "node:test";

import { APP_KEYS, type DaemonStatusSnapshot, type WebStatusSnapshot } from "@z-design/sidecar-proto";
