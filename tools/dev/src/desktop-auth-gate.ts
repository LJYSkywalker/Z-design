import type { DaemonStatusSnapshot, WebStatusSnapshot } from "@z-design/sidecar-proto";
import { APP_KEYS } from "@z-design/sidecar-proto";

/**
 * PR #974 round 6 (mrcfps): close the split-start dev-flow gap.
 *
 * `tools-dev start daemon` followed by `tools-dev start desktop` was
 * leaving the daemon running without `ZD_REQUIRE_DESKTOP_AUTH=1`,
