...
const BUILD_COMMANDS = [
  { args: ["--filter", "@z-design/components", "build"] },
  { args: ["--filter", "@z-design/contracts", "build"] },
  { args: ["--filter", "@z-design/registry-protocol", "build"] },
  { args: ["--filter", "@z-design/sidecar-proto", "build"] },
  { args: ["--filter", "@z-design/launcher-proto", "build"] },
  { args: ["--filter", "@z-design/sidecar", "build"] },
  { args: ["--filter", "@z-design/platform", "build"] },
  { args: ["--filter", "@z-design/download", "build"] },
  { args: ["--filter", "@z-design/host", "build"] },
  { args: ["--filter", "@z-design/agui-adapter", "build"] },
  { args: ["--filter", "@z-design/plugin-runtime", "build"] },
  { args: ["--filter", "@z-design/diagnostics", "build"] },
  { args: ["--filter", "@z-design/daemon", "build"] },
  { args: ["--filter", "@z-design/web", "build"], env: ["ZD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@z-design/web", "build:sidecar"] },
  { args: ["--filter", "@z-design/desktop", "build"] },
  { args: ["--filter", "@z-design/packaged", "build"] },
] as const;
