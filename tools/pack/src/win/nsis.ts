...
LangString ZD_REMOVE_LOCAL_DATA_TITLE 1033 "Remove local data"
LangString ZD_REMOVE_LOCAL_DATA_TITLE 2052 "删除本地数据"
LangString ZD_REMOVE_LOCAL_DATA_TITLE 1028 "刪除本機資料"
LangString ZD_REMOVE_LOCAL_DATA_TITLE 1046 "Remover dados locais"
LangString ZD_REMOVE_LOCAL_DATA_TITLE 1049 "Удалить локальные данные"
LangString ZD_REMOVE_LOCAL_DATA_TITLE 1065 "حذف داده‌های محلی"

LangString ZD_REMOVE_LOCAL_DATA_HINT 1033 "Choose whether the uninstaller should remove Open Design data stored on this computer."
LangString ZD_REMOVE_LOCAL_DATA_HINT 2052 "请选择卸载程序是否删除此电脑上保存的 Open Design 数据。"
LangString ZD_REMOVE_LOCAL_DATA_HINT 1028 "請選擇解除安裝程式是否刪除此電腦上儲存的 Open Design 資料。"
LangString ZD_REMOVE_LOCAL_DATA_HINT 1046 "Escolha se o desinstalador deve remover os dados do Open Design armazenados neste computador."
LangString ZD_REMOVE_LOCAL_DATA_HINT 1049 "Выберите, должен ли деинсталлятор удалить данные Open Design, сохраненные на этом компьютере."
LangString ZD_REMOVE_LOCAL_DATA_HINT 1065 "انتخاب کنید که حذف‌کننده داده‌های Open Design ذخیره‌شده در این رایانه را حذف کند یا نه."

LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 1033 "Remove local Open Design data:"
LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 2052 "删除本地 Open Design 数据："
LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 1028 "刪除本機 Open Design 資料："
LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 1046 "Remover dados locais do Open Design:"
LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 1049 "Удалить локальные данные Open Design:"
LangString ZD_REMOVE_LOCAL_DATA_CHECKBOX 1065 "حذف داده‌های محلی Open Design:"

!macro customUnWelcomePage
  !insertmacro MUI_UNPAGE_WELCOME
  UninstPage custom un.ZDesignLocalDataPage un.ZDesignLocalDataPageLeave
!macroend

Function un.ZDesignLocalDataPage
  ...
  \${NSD_CreateLabel} 0 0 100% 24u "$(ZD_REMOVE_LOCAL_DATA_HINT)"
  Pop $0
  \${NSD_CreateCheckbox} 0 34u 100% 36u "$(ZD_REMOVE_LOCAL_DATA_CHECKBOX) $odLocalDataRoot"
  Pop $odRemoveLocalDataCheckbox
  \${NSD_Check} $odRemoveLocalDataCheckbox
  nsDialogs::Show
FunctionEnd

Function un.ZDesignLocalDataPageLeave
