...
If you're not sure your idea fits, **open a discussion first** ([github.com/Aqu-210L/Z-design/discussions](https://github.com/Aqu-210L/Z-design/discussions)) — we'd rather spend 5 minutes redirecting than have you build the wrong thing for a week.
