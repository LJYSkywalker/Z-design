...
> **Branch:** [`main`](https://github.com/Aqu-210L/Z-design/tree/main) — everything below tracks `main`
...
→ [**Open a 0.8.0 preview feedback issue**](https://github.com/Aqu-210L/Z-design/issues/new?template=preview-v0.8.0-feedback.yml) — bugs, suggestions, first impressions, all welcome. The team watches [all open issues](https://github.com/Aqu-210L/Z-design/issues).
...
If you want to send a fix instead, open a PR against `main` as usual — 0.8.0 work now lives there. [See what's open.](https://github.com/Aqu-210L/Z-design/pulls)
