...
> **分支：** [`main`](https://github.com/Aqu-210L/Z-design/tree/main)——下文所有内容都跟随 `main`
...
→ [**提交一个 0.8.0 preview 反馈 issue**](https://github.com/Aqu-210L/Z-design/issues/new?template=preview-v0.8.0-feedback.yml)——bug、建议、第一印象都欢迎。团队盯着[所有开着的 issues](https://github.com/Aqu-210L/Z-design/issues)。
...
如果你想直接发修复，按惯例提 PR 到 `main` 即可——0.8.0 的代码现在就在那里。[看看正在飞行中的 PR。](https://github.com/Aqu-210L/Z-design/pulls)
