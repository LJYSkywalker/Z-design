...
> 🔥 **Z-design 0.10.0 正式發布：All-in-one 的 Agentic 設計工作台。** 設計的完整流程從此只需一個視窗——從一個模糊的想法出發，到發現參考、蒐集素材、互動式編輯、留言排入佇列、打磨動效，再交付給編輯器或 Code Agent，全程無須離開應用程式。搭配多會話並行，它不再只是一個助手，而是一支為你工作的本地設計團隊。[下載 0.10.0](https://github.com/Aqu-210L/Z-design/releases) · [參與討論](https://github.com/Aqu-210L/Z-design/discussions/4153)
>
<p align="center">
...
從 [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases) 下載對應平台最新建置：
...
- **Linux**（AppImage，選用通道）→ [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
...
- 🗣️ **GitHub Discussions**——深入問答、RFC、「秀出你的成果」 → [**Discussions**](https://github.com/Aqu-210L/Z-design/discussions)
- 🐛 **GitHub Issues**——錯誤回報、功能請求 → [**Issues**](https://github.com/Aqu-210L/Z-design/issues)

[`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 與 [`help-wanted`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) 這兩個標籤是最容易的入門方式。
...
| 修錯誤或打磨 UI | 瀏覽 [`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 標籤 | [Issues →](https://github.com/Aqu-210L/Z-design/issues) |
