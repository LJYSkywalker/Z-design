...
어느 쪽에 해당하는지 모르겠다면 [먼저 discussion이나 issue를 열어주세요](https://github.com/Aqu-210L/Z-design/issues/new). 적절한 위치를 안내해 드리겠습니다.
...
- 아키텍처 질문, 설계 질문, "이게 버그인지 오용인지" → [GitHub Discussions](https://github.com/Aqu-210L/Z-design/discussions) (권장 — 다음 사람이 검색할 수 있습니다).
