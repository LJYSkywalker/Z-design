...
> 🔥 **Z-design 0.10.0 が登場——オールインワンの Agentic デザインワークスペース。** デザインの全工程が、ひとつのウィンドウに。曖昧なアイデアから、リファレンス探し、素材集め、インタラクティブな編集、コメントのキュー投入、モーションの仕上げ、そしてエディタや Code Agent への受け渡しまで——アプリを離れることなく完結します。複数セッションの並行実行で、それはもはや一人のアシスタントではなく、あなたのために働くローカルなデザインチームです。[0.10.0 をダウンロード](https://github.com/Aqu-210L/Z-design/releases) · [ディスカッションに参加](https://github.com/Aqu-210L/Z-design/discussions/4153)
>
<p align="center">
...
[GitHub Releases](https://github.com/Aqu-210L/Z-design/releases) から各プラットフォームの最新ビルドをダウンロード：
...
- **macOS**（Apple Silicon · Intel x64）→ [**open-design.ai**](https://open-design.ai/) または [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
- **Windows**（x64）→ [**open-design.ai**](https://open-design.ai/) または [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
- **Linux**（AppImage、オプションのレーン）→ [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
...
- 🗣️ **GitHub Discussions** — 深い Q&A、RFC、「成果を見せて」 → [**Discussions**](https://github.com/Aqu-210L/Z-design/discussions)
- 🐛 **GitHub Issues** — バグ報告、機能リクエスト → [**Issues**](https://github.com/Aqu-210L/Z-design/issues)

[`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) と [`help-wanted`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) のラベルが、最も入りやすい入口です。
...
| バグ修正や UI の磨き上げ | [`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) ラベルを閲覧 | [Issues →](https://github.com/Aqu-210L/Z-design/issues) |
