...
不确定自己想做的属于哪一桶？[先开 issue / discussion](https://github.com/Aqu-210L/Z-design/issues/new)，我们告诉你该改哪个面。
...
- 架构问题、设计问题、「这是 bug 还是误用」 → 请用 [GitHub Discussions](https://github.com/Aqu-210L/Z-design/discussions)（首选 —— 下一个人能搜到）。
