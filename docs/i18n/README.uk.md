...
Завантажте свіжий білд для вашої платформи з [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases):
...
- **macOS** (Apple Silicon · Intel x64) → [**open-design.ai**](https://open-design.ai/) або [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
- **Windows** (x64) → [**open-design.ai**](https://open-design.ai/) або [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
- **Linux** (AppImage, опціональна лінія) → [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
...
- 🗣️ **GitHub Discussions** — глибокі Q&A, RFC, «покажи свою роботу» → [**Discussions**](https://github.com/Aqu-210L/Z-design/discussions)
- 🐛 **GitHub Issues** — звіти про баги, запити на функції → [**Issues**](https://github.com/Aqu-210L/Z-design/issues)

Мітки [`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) та [`help-wanted`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) — найлегший спосіб долучитися.
...
| Виправити баг або відполірувати UI | Перегляньте мітку [`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) | [Issues →](https://github.com/Aqu-210L/Z-design/issues) |
