...
- **Linux**（AppImage，可选通道）→ [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases)
...
- 🗣️ **GitHub Discussions**——深度问答、RFC、"展示你的作品" → [**Discussions**](https://github.com/Aqu-210L/Z-design/discussions)
- 🐛 **GitHub Issues**——Bug 报告、功能请求 → [**Issues**](https://github.com/Aqu-210L/Z-design/issues)

[`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 和 [`help-wanted`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) 标签是最简单的入门方式。
...
| 修复 Bug 或打磨 UI | 浏览 [`good-first-issue`](https://github.com/Aqu-210L/Z-design/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) 标签 | [Issues →](https://github.com/Aqu-210L/Z-design/issues) |
