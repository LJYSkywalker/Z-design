...
Wenn Sie nicht sicher sind, in welchen Bereich Ihre Idee fällt, [öffnen Sie zuerst eine Discussion / Issue](https://github.com/Aqu-210L/Z-design/issues/new). Wir zeigen Ihnen dann die passende Oberfläche.
...
- Architekturfrage, Designfrage, "Bug oder Fehlbenutzung?" → [GitHub Discussions](https://github.com/Aqu-210L/Z-design/discussions) (bevorzugt, weil suchbar).
