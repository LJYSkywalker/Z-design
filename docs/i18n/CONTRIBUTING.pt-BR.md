...
Se você não tem certeza em qual balde sua ideia se encaixa, [abra primeiro uma discussion / issue](https://github.com/Aqu-210L/Z-design/issues/new) e te apontamos para a superfície certa.
...
- Pergunta de arquitetura, pergunta de design, "isso é bug ou mau uso" → [GitHub Discussions](https://github.com/Aqu-210L/Z-design/discussions) (preferido — pesquisável para o próximo).
...
[discussions]: https://github.com/Aqu-210L/Z-design/discussions
