...
> 🍃 **Ce projet est basé sur [Open Design](https://github.com/nexu-io/open-design) et optimisé et amélioré pour [GLM (Zhipu)](https://www.zhipuai.cn/).** Il conserve le workspace de design agentique complet d'Open Design en amont tout en adaptant la boucle de l'agent, les prompts et l'intégration du modèle aux appels d'outils de GLM-5.2, afin que tout le flux s'exécute nativement sur la famille GLM plutôt que sur Claude uniquement.

Le mérite du produit original, des skills, des systèmes de design et des plugins revient à l'équipe Open Design et à ses contributeurs. Ce fork se concentre sur :
...
**261 plugins officiels** se trouvent dans [`plugins/_official/`](../../plugins/_official/). Chaque plugin est un **dossier d'agent-skill portable** — un `SKILL.md` (lisible par tout agent prenant en charge les Agent Skills), plus un manifeste `z-design.json` optionnel qui donne à Open Design des métadonnées de marketplace, des entrées, des aperçus, des pipelines et des déclarations de capacités. Accédez directement à une catégorie :
...
Un plugin **n'a besoin au minimum que d'un `SKILL.md`** ; pour le lister dans la marketplace Open Design, ajoutez un `z-design.json` :
...
<p align="center">
  <a href="https://github.com/Aqu-210L/Z-design"><img src="https://repo-assets.open-design.ai/resources/images/star-us.png" alt="Mettez une étoile à Open Design sur GitHub — github.com/Aqu-210L/Z-design" width="100%" /></a>
</p>
