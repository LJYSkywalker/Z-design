...
- Must not import from `@z-design/web`, `@z-design/daemon`,
  `@z-design/desktop`, `@z-design/sidecar*`, or
  `@z-design/contracts`. Those are product runtime concerns.
...
```bash
pnpm --filter @z-design/landing-page dev          # http://127.0.0.1:17574
pnpm --filter @z-design/landing-page typecheck
pnpm --filter @z-design/landing-page previews     # render thumbnails
pnpm --filter @z-design/landing-page build        # static export → out/
```
