...
const DEFAULT_WELCOME_EMAIL_FROM = "Open Design <updates@z-design.ai>";
const DEFAULT_WELCOME_EMAIL_REPLY_TO = "updates@z-design.ai";
const WELCOME_EMAIL_SUBJECT = "Welcome to ZDesign — you're in 🎉";
const WELCOME_EMAIL_TEXT = `Hi there,

Thanks for subscribing to the ZDesign newsletter — you're officially on the list.
...
<html>
  <body style="margin:0;padding:0;background:#f7f2e7;color:#171511;font-family:Inter,Arial,sans-serif;">
    <div style="max-width:640px;margin:0 auto;padding:40px 24px;">
      <h1 style="margin:0 0 20px;font-family:Georgia,'Times New Roman',serif;font-size:32px;line-height:1.15;color:#171511;">Welcome to ZDesign</h1>
      <p style="margin:0 0 18px;font-size:16px;line-height:1.6;">Hi there,</p>
      <p style="margin:0 0 18px;font-size:16px;line-height:1.6;">Thanks for subscribing to the ZDesign newsletter — you're officially on the list.</p>
      ...
      <p style="margin:0 0 28px;font-size:16px;line-height:1.6;">Talk soon,<br>The ZDesign Team</p>
