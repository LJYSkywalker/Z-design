...
<script>
  ...
  document.addEventListener('click', function (event) {
    ...
    if (lowerHref.includes('github.com/Aqu-210L/Z-design/releases')) { cta = 'download_desktop'; downloadTarget = 'direct'; }
    ...
    else if (lowerHref === 'https://github.com/Aqu-210L/Z-design' || lowerLabel.includes('star')) cta = 'star_github';
    else if (lowerHref.includes('discord.gg/')) cta = 'join_discord';
    else if (lowerHref.includes('github.com/Aqu-210L/Z-design/issues')) cta = 'open_issue';
