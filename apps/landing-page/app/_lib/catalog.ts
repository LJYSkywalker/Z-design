...
//
// Previews are produced offline by `pnpm --filter @z-design/landing-page
...
const PREVIEWS_ROOT_CANDIDATES = [
  // `pnpm --filter @z-design/landing-page build` may keep cwd at the
...
const REPO_TREE = 'https://github.com/Aqu-210L/Z-design/tree/main';
const REPO_BLOB = 'https://github.com/Aqu-210L/Z-design/blob/main';
