...
| 2026-05-18 | port-figma-workflow-open-design-plugin | Use cases | 17 | pending (just shipped) | pending | — | 2026-06-18 | Use-case post from the 0.8.0-preview plugin call. Turns "port a Figma workflow" into a concrete `SKILL.md` + `z-design.json` + validate/pack/publish path. CTA = `Try this workflow`. |
...
- https://github.com/Aqu-210L/Z-design/issues — same data via web for skim/triage
