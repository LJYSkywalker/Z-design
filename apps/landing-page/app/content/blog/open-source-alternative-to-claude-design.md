...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">试试开源工作流</a>。</p>
      <h2>延伸阅读</h2>
      <ul>
  ...
  zh-tw:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">試試這套開源工作流程</a>。</p>
      <h2>延伸閱讀</h2>
      <ul>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">オープンソースのワークフローを試す</a>。</p>
      <h2>関連する読み物</h2>
      <ul>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">오픈소스 워크플로 시도하기</a>.</p>
      <h2>관련 읽을거리</h2>
      <ul>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Probier den Open-Source-Workflow aus</a>.</p>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Попробовать рабочий процесс с открытым исходным кодом</a>.</p>
  ...
  vi:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Thử quy trình mã nguồn mở</a>.</p>
      <h2>Đọc thêm</h2>
      <ul>
  ...
  pl:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Wypróbuj otwartoźródłowy przepływ pracy</a>.</p>
  ...
  id:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Coba alur kerja open-source-nya</a>.</p>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Açık kaynak iş akışını deneyin</a>.</p>
