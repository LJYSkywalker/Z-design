...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <p>0.9.0 把这些步骤删掉了。</p>
      <p>如果你想看长版本,<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub 上的发布说明</a>有全部细节。这篇是短版本:底层改了什么、今天能拿它做什么、以及从哪开始。</p>
      ...
      <p>完整清单是 310 个 PR。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub 上的发布说明</a>装着其余的部分。</p>
  ...
  zh-tw:
    ...
    bodyHtml: |
      ...
      <p>0.9.0 把這些步驟刪掉了。</p>
      <p>如果你想看長版本，<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub 上的發布說明</a>有全部細節。這篇是短版本：底層改了什麼、今天能拿它做什麼、以及從哪開始。</p>
      ...
      <p>完整清單是 310 個 PR。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub 上的發布說明</a>裝著其餘的部分。</p>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <p>詳しいバージョンが知りたい場合は、<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub のリリースノート</a>にすべて載っています。この記事は短いバージョンです。内部で何が変わったのか、今日それで何ができるのか、そしてどこから始めればいいのか。</p>
      ...
      <p>完全なリストは 310 件の PR に及びます。残りは <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub のリリースノート</a>が引き受けています。</p>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <p>긴 버전을 원한다면 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub의 릴리스 노트</a>에 전부 담겨 있습니다. 이 글은 짧은 버전입니다. 내부적으로 무엇이 바뀌었는지, 오늘 그것으로 무엇을 할 수 있는지, 그리고 어디서부터 시작하면 되는지.</p>
      ...
      <p>전체 목록은 310개의 PR에 달합니다. 나머지는 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub의 릴리스 노트</a>에 담겨 있습니다.</p>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <p>Wenn du die lange Fassung willst: Die <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Release Notes auf GitHub</a> haben sie. Dieser Beitrag ist die Kurzfassung: was sich unter der Haube geändert hat, was du heute damit machen kannst und wo du anfängst.</p>
      ...
      <p>Die vollständige Liste umfasst 310 PRs. Die <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Release Notes auf GitHub</a> tragen den Rest.</p>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <p>Si vous voulez la version longue, les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notes de version sur GitHub</a> la contiennent. Ce billet est la version courte : ce qui a changé sous le capot, ce que vous pouvez en faire aujourd'hui, et par où commencer.</p>
      ...
      <p>La liste complète atteint 310 PR. Les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notes de version sur GitHub</a> portent le reste.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Télécharger Open Design</a>.</p>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <p>Если вам нужна длинная версия, в <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">примечаниях к релизу на GitHub</a> есть все детали. Этот пост — короткая версия: что изменилось под капотом, что вы можете сделать с этим сегодня и с чего начать.</p>
      ...
      <p>Полный список доходит до 310 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Примечания к релизу на GitHub</a> содержат всё остальное.</p>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <p>Si quieres la versión larga, las <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notas de lanzamiento en GitHub</a> la tienen. Este artículo es la versión corta: qué cambió bajo el capó, qué puedes hacer con ello hoy y por dónde empezar.</p>
      ...
      <p>La lista completa llega a 310 PRs. Las <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notas de lanzamiento en GitHub</a> tienen el resto.</p>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <p>Se você quer a versão longa, as <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notas de lançamento no GitHub</a> têm tudo. Este post é a versão curta: o que mudou por baixo dos panos, o que você pode fazer com isso hoje e por onde começar.</p>
      ...
      <p>A lista completa chega a 310 PRs. As <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">notas de lançamento no GitHub</a> carregam o resto.</p>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <p>Se vuoi la versione lunga, le <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">note di rilascio su GitHub</a> la contengono. Questo post è la versione breve: cosa è cambiato sotto il cofano, cosa puoi farci oggi e da dove iniziare.</p>
      ...
      <p>La lista completa arriva a 310 PR. Le <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">note di rilascio su GitHub</a> contengono il resto.</p>
  ...
  vi:
    ...
    bodyHtml: |
      ...
      <p>Nếu bạn muốn bản dài, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">ghi chú phát hành trên GitHub</a> có đầy đủ chi tiết. Bài này là bản ngắn: điều gì đã thay đổi ở bên dưới, hôm nay bạn có thể làm gì với nó, và bắt đầu từ đâu.</p>
      ...
      <p>Danh sách đầy đủ lên tới 310 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Ghi chú phát hành trên GitHub</a> chứa phần còn lại.</p>
  ...
  pl:
    ...
    bodyHtml: |
      ...
      <p>Jeśli chcesz dłuższą wersję, mają ją <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">informacje o wydaniu na GitHub</a>. Ten wpis to wersja krótka: co zmieniło się pod maską, co możesz z tym zrobić już dziś i od czego zacząć.</p>
      ...
      <p>Pełna lista sięga 310 PR-ów. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Informacje o wydaniu na GitHub</a> niosą resztę.</p>
  ...
  id:
    ...
    bodyHtml: |
      ...
      <p>Jika Anda ingin versi panjangnya, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">catatan rilis di GitHub</a> memuat semuanya. Tulisan ini adalah versi singkatnya: apa yang berubah di balik layar, apa yang bisa Anda lakukan dengannya hari ini, dan dari mana harus mulai.</p>
      ...
      <p>Daftar lengkapnya mencapai 310 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Catatan rilis di GitHub</a> memuat sisanya.</p>
  ...
  nl:
    ...
    bodyHtml: |
      ...
      <p>Wil je de lange versie, dan staat die in de <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">release notes op GitHub</a>. Dit bericht is de korte versie: wat er onder de motorkap is veranderd, wat je er vandaag mee kunt doen en waar je begint.</p>
      ...
      <p>De volledige lijst loopt op tot 310 PR's. De <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">release notes op GitHub</a> bevatten de rest.</p>
  ...
  ar:
    ...
    bodyHtml: |
      ...
      <p>إذا أردت النسخة الطويلة، <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">ملاحظات الإصدار على GitHub</a> تحتوي عليها. هذه التدوينة هي النسخة المختصرة: ما الذي تغيّر تحت الغطاء، وما الذي يمكنك فعله به اليوم، ومن أين تبدأ.</p>
      ...
      <p>القائمة الكاملة تصل إلى 310 طلبات سحب. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">ملاحظات الإصدار على GitHub</a> تحمل بقية التفاصيل.</p>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <p>Uzun versiyonu isterseniz, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub'daki sürüm notlarında</a> hepsi var. Bu yazı kısa versiyon: kaputun altında ne değişti, bugün bununla ne yapabilirsiniz ve nereden başlamalısınız.</p>
      ...
      <p>Tam liste 310 PR'a ulaşıyor. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">GitHub'daki sürüm notları</a> geri kalanını taşıyor.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Open Design'ı indir</a>.</p>
  ...
  uk:
    ...
    bodyHtml: |
      ...
      <p>Якщо ви хочете довгу версію, її містять <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">примітки до релізу на GitHub</a>. Цей допис — коротка версія: що змінилося під капотом, що ви можете робити з цим сьогодні та з чого почати.</p>
      ...
      <p>Повний список сягає 310 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0">Примітки до релізу на GitHub</a> несуть решту.</p>
...
If you want the long version, the [release notes on GitHub](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0) have it. This post is the short version: what changed under the hood, what you can do with it today, and where to start.
...
The full list runs to 310 PRs. The [release notes on GitHub](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.9.0) carry the rest.
