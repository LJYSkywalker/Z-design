...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <p>完整清单一直排到 305 个 PR。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">GitHub 上的发布说明</a> 承载着其余部分。</p>
      <h2>今天能拿它做什么</h2>
      <p>三条路径，取决于你从哪里开始。</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">下载桌面应用</a>。</p>
      <h2>延伸阅读</h2>
      <ul>
  ...
  zh-tw:
    ...
    bodyHtml: |
      ...
      <p>完整清單長達 305 個 PR。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">GitHub 上的發布說明</a>承載了其餘的部分。</p>
      <h2>今天能拿它做什麼</h2>
      <p>三條路徑，取決於你從哪裡開始。</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">下載桌面版</a>。</p>
      <h2>延伸閱讀</h2>
      <ul>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <p>完全なリストは 305 件の PR に及びます。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">GitHub のリリースノート</a>が残りを運んでいます。</p>
      <h2>今日それで何をするか</h2>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">デスクトップをダウンロード</a>。</p>
      <h2>関連する読み物</h2>
      <ul>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <p>전체 목록은 305개 PR에 이른다. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">GitHub의 릴리스 노트</a>가 나머지를 담고 있다.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">데스크톱 내려받기</a>.</p>
      <h2>관련 읽을거리</h2>
      <ul>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <p>Die vollständige Liste umfasst 305 PRs. Die <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Release-Notes auf GitHub</a> tragen den Rest.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Desktop herunterladen</a>.</p>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <p>La liste complète atteint 305 PR. Les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">notes de version sur GitHub</a> portent le reste.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Télécharger le desktop</a>.</p>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <p>Полный список насчитывает 305 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Заметки о релизе на GitHub</a> несут остальное.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Скачать десктоп</a>.</p>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <p>La lista completa llega a 305 PRs. Las <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">notas de la versión en GitHub</a> tienen el resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Descargar escritorio</a>.</p>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <p>A lista completa chega a 305 PRs. As <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">notas de release no GitHub</a> trazem o resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Baixe o desktop</a>.</p>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <p>La lista completa arriva a 305 PR. Le <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">note di rilascio su GitHub</a> contengono il resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Scarica desktop</a>.</p>
  ...
  vi:
    ...
    bodyHtml: |
      ...
      <p>Danh sách đầy đủ lên tới 305 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Ghi chú phát hành trên GitHub</a> mang theo phần còn lại.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Tải desktop</a>.</p>
      <h2>Đọc thêm</h2>
      <ul>
  ...
  pl:
    ...
    bodyHtml: |
      ...
      <p>Pełna lista liczy 305 PR-ów. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Notatki o wydaniu na GitHub</a> niosą resztę.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Pobierz wersję desktopową</a>.</p>
  ...
  id:
    ...
    bodyHtml: |
      ...
      <p>Daftar lengkapnya mencapai 305 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Catatan rilis di GitHub</a> membawa sisanya.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Unduh desktop</a>.</p>
  ...
  nl:
    ...
    bodyHtml: |
      ...
      <p>De volledige lijst loopt op tot 305 PR's. De <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">release notes op GitHub</a> bevatten de rest.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Download desktop</a>.</p>
  ...
  ar:
    ...
    bodyHtml: |
      ...
      <p>القائمة الكاملة تبلغ 305 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">ملاحظات الإصدار على GitHub</a> تحمل الباقي.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">نزّل سطح المكتب</a>.</p>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <p>Tam liste 305 PR'a ulaşıyor. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">GitHub'daki sürüm notları</a> geri kalanını taşıyor.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Masaüstünü indirin</a>.</p>
  ...
  uk:
    ...
    bodyHtml: |
      ...
      <p>Повний список сягає 305 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Нотатки до релізу на GitHub</a> містять решту.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0">Завантажити для десктопа</a>.</p>
...
The full list runs to 305 PRs. The [release notes on GitHub](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0) carry the rest.
...
[Download desktop](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.8.0).
