...
i18n:
  zh:
    ...
    bodyHtml: |
      ...
      <p>想看完整版本，可以查阅 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub 上的发布说明</a>。本文是精简版：底层改了什么、你今天能用它做什么，以及从哪里开始。</p>
      ...
      <ul>
        ...
        <li><strong>面向每一种桌面的构建。</strong>macOS（Apple Silicon 与 Intel x64）和 Windows（安装版与便携版），通过 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> 和 releases.open-design.ai 提供。</li>
      </ul>
      <p>完整清单长达 405 个 PR。其余内容都在 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub 上的发布说明</a>里。</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">下载 Open Design</a>。</p>
  ...
  zh-tw:
    ...
    bodyHtml: |
      ...
      <p>如果你想看完整版本，<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub 上的發佈說明</a>有全部內容。本文是精簡版：底層改了什麼、今天你能用它做什麼，以及從何處著手。</p>
      ...
      <ul>
        ...
        <li><strong>為每種桌面平台建置。</strong>macOS（Apple Silicon 與 Intel x64）與 Windows（安裝程式與免安裝版），透過 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> 與 releases.open-design.ai 取得。</li>
      </ul>
      <p>完整清單多達 405 個 PR。<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub 上的發佈說明</a>收錄了其餘部分。</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">下載 Open Design</a>。</p>
  ...
  ja:
    ...
    bodyHtml: |
      ...
      <p>詳細版が読みたい方は、<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub のリリースノート</a>をご覧ください。本記事は短縮版です：内部で何が変わったか、今日それで何ができるか、そしてどこから始めればよいか。</p>
      ...
      <ul>
        ...
        <li><strong>あらゆるデスクトップ向けのビルド。</strong><a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> と releases.open-design.ai 経由で、macOS（Apple Silicon および Intel x64）と Windows（インストーラーおよびポータブル）に対応。</li>
      </ul>
      <p>全リストは405件のPRに及びます。残りは<a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub のリリースノート</a>に記載されています。</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Open Design をダウンロード</a>。</p>
  ...
  ko:
    ...
    bodyHtml: |
      ...
      <p>긴 버전이 궁금하다면 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub의 릴리스 노트</a>에 담겨 있습니다. 이 글은 짧은 버전입니다: 내부에서 무엇이 바뀌었는지, 오늘 그것으로 무엇을 할 수 있는지, 그리고 어디서 시작하면 되는지.</p>
      ...
      <ul>
        ...
        <li><strong>모든 데스크톱을 위한 빌드.</strong> macOS (Apple Silicon 및 Intel x64)와 Windows (인스톨러 및 포터블), <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a>와 releases.open-design.ai를 통해 제공됩니다.</li>
      </ul>
      <p>전체 목록은 405개의 PR에 이릅니다. 나머지는 <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub의 릴리스 노트</a>에 담겨 있습니다.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Open Design 다운로드</a>.</p>
  ...
  de:
    ...
    bodyHtml: |
      ...
      <p>Wenn du die ausführliche Version möchtest, findest du sie in den <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Release Notes auf GitHub</a>. Dieser Beitrag ist die Kurzfassung: was sich unter der Haube geändert hat, was du heute damit machen kannst und wo du anfängst.</p>
      ...
      <ul>
        ...
        <li><strong>Builds für jeden Desktop.</strong> macOS (Apple Silicon und Intel x64) und Windows (Installer und portabel) über <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> und releases.open-design.ai.</li>
      </ul>
      <p>Die vollständige Liste umfasst 405 PRs. Die <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Release Notes auf GitHub</a> enthalten den Rest.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Open Design herunterladen</a>.</p>
  ...
  fr:
    ...
    bodyHtml: |
      ...
      <p>Si vous voulez la version longue, les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notes de version sur GitHub</a> la contiennent. Cet article est la version courte : ce qui a changé sous le capot, ce que vous pouvez en faire dès aujourd'hui, et par où commencer.</p>
      ...
      <ul>
        ...
        <li><strong>Des builds pour chaque bureau.</strong> macOS (Apple Silicon et Intel x64) et Windows (programme d'installation et version portable) via les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> et releases.open-design.ai.</li>
      </ul>
      <p>La liste complète compte 405 PR. Les <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notes de version sur GitHub</a> contiennent le reste.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Téléchargez Open Design</a>.</p>
  ...
  ru:
    ...
    bodyHtml: |
      ...
      <p>Если вам нужна развёрнутая версия, она есть в <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">примечаниях к релизу на GitHub</a>. Этот пост — краткая версия: что изменилось под капотом, что вы можете сделать с этим уже сегодня и с чего начать.</p>
      ...
      <ul>
        ...
        <li><strong>Сборки для любого десктопа.</strong> macOS (Apple Silicon и Intel x64) и Windows (установщик и портативная версия) через <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> и releases.open-design.ai.</li>
      </ul>
      <p>Полный список насчитывает 405 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Примечания к релизу на GitHub</a> содержат остальное.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Скачать Open Design</a>.</p>
  ...
  es:
    ...
    bodyHtml: |
      ...
      <p>Si quieres la versión larga, las <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notas de la versión en GitHub</a> la tienen. Esta publicación es la versión corta: qué cambió por dentro, qué puedes hacer con ello hoy y por dónde empezar.</p>
      ...
      <ul>
        ...
        <li><strong>Compilaciones para cada escritorio.</strong> macOS (Apple Silicon e Intel x64) y Windows (instalador y portable) a través de <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> y releases.open-design.ai.</li>
      </ul>
      <p>La lista completa llega a 405 PRs. Las <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notas de la versión en GitHub</a> tienen el resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Descarga Open Design</a>.</p>
  ...
  pt-br:
    ...
    bodyHtml: |
      ...
      <p>Se você quer a versão longa, as <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notas de versão no GitHub</a> têm tudo. Este post é a versão curta: o que mudou por baixo dos panos, o que você pode fazer com isso hoje e por onde começar.</p>
      ...
      <ul>
        ...
        <li><strong>Builds para todo desktop.</strong> macOS (Apple Silicon e Intel x64) e Windows (instalador e portátil) via <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> e releases.open-design.ai.</li>
      </ul>
      <p>A lista completa chega a 405 PRs. As <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">notas de versão no GitHub</a> trazem o resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Baixe o Open Design</a>.</p>
  ...
  it:
    ...
    bodyHtml: |
      ...
      <p>Se vuoi la versione lunga, le <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">note di rilascio su GitHub</a> ce l'hanno. Questo post è la versione breve: cosa è cambiato sotto il cofano, cosa puoi farci oggi e da dove iniziare.</p>
      ...
      <ul>
        ...
        <li><strong>Build per ogni desktop.</strong> macOS (Apple Silicon e Intel x64) e Windows (installer e portable) tramite <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> e releases.open-design.ai.</li>
      </ul>
      <p>L'elenco completo arriva a 405 PR. Le <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">note di rilascio su GitHub</a> contengono il resto.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Scarica Open Design</a>.</p>
  ...
  vi:
    ...
    bodyHtml: |
      ...
      <p>Nếu bạn muốn bản đầy đủ, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">ghi chú phát hành trên GitHub</a> có sẵn. Bài viết này là bản ngắn gọn: những gì đã thay đổi bên trong, bạn có thể làm gì với nó ngay hôm nay, và bắt đầu từ đâu.</p>
      ...
      <ul>
        ...
        <li><strong>Bản dựng cho mọi desktop.</strong> macOS (Apple Silicon và Intel x64) và Windows (trình cài đặt và bản di động) qua <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> và releases.open-design.ai.</li>
      </ul>
      <p>Danh sách đầy đủ lên tới 405 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Ghi chú phát hành trên GitHub</a> chứa phần còn lại.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Tải Open Design</a>.</p>
  ...
  pl:
    ...
    bodyHtml: |
      ...
      <p>Jeśli chcesz dłuższej wersji, znajdziesz ją w <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">informacjach o wydaniu na GitHub</a>. Ten wpis to wersja skrócona: co zmieniło się pod maską, co możesz z tym zrobić już dziś i od czego zacząć.</p>
      ...
      <ul>
        ...
        <li><strong>Wersje na każdy pulpit.</strong> macOS (Apple Silicon i Intel x64) oraz Windows (instalator i wersja przenośna) poprzez <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> i releases.open-design.ai.</li>
      </ul>
      <p>Pełna lista sięga 405 PR-ów. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Informacje o wydaniu na GitHub</a> niosą resztę.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Pobierz Open Design</a>.</p>
  ...
  id:
    ...
    bodyHtml: |
      ...
      <p>Kalau ingin versi panjangnya, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">catatan rilis di GitHub</a> sudah menyediakannya. Tulisan ini adalah versi singkatnya: apa yang berubah di balik layar, apa yang bisa Anda lakukan dengannya hari ini, dan dari mana memulai.</p>
      ...
      <ul>
        ...
        <li><strong>Build untuk setiap desktop.</strong> macOS (Apple Silicon dan Intel x64) dan Windows (installer dan portable) melalui <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> dan releases.open-design.ai.</li>
      </ul>
      <p>Daftar lengkapnya mencapai 405 PR. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">Catatan rilis di GitHub</a> memuat selebihnya.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Unduh Open Design</a>.</p>
  ...
  nl:
    ...
    bodyHtml: |
      ...
      <p>Wil je de uitgebreide versie, dan vind je die in de <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">release notes op GitHub</a>. Dit bericht is de korte versie: wat er onder de motorkap is veranderd, wat je er vandaag mee kunt doen en waar je begint.</p>
      ...
      <ul>
        ...
        <li><strong>Builds voor elke desktop.</strong> macOS (Apple Silicon en Intel x64) en Windows (installer en portable) via <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> en releases.open-design.ai.</li>
      </ul>
      <p>De volledige lijst loopt op tot 405 PR's. De <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">release notes op GitHub</a> bevatten de rest.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Download Open Design</a>.</p>
  ...
  ar:
    ...
    bodyHtml: |
      ...
      <p>إذا أردت النسخة المطوّلة، فإن <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">ملاحظات الإصدار على GitHub</a> تتضمنها. هذه التدوينة هي النسخة المختصرة: ما الذي تغيّر تحت الغطاء، وما الذي يمكنك فعله به اليوم، ومن أين تبدأ.</p>
      ...
      <ul>
        ...
        <li><strong>إصدارات لكل سطح مكتب.</strong> macOS (‏Apple Silicon و‏Intel x64) و‏Windows (المثبّت والمحمول) عبر <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> و releases.open-design.ai.</li>
      </ul>
      <p>تمتد القائمة الكاملة إلى 405 طلب دمج. وتتضمن <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">ملاحظات الإصدار على GitHub</a> البقية.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">نزّل Open Design</a>.</p>
  ...
  tr:
    ...
    bodyHtml: |
      ...
      <p>Uzun versiyonunu istiyorsanız, <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub'daki sürüm notları</a> hepsini içeriyor. Bu yazı kısa versiyon: kaputun altında ne değişti, bununla bugün ne yapabilirsiniz ve nereden başlamalısınız.</p>
      ...
      <ul>
        ...
        <li><strong>Her masaüstü için derlemeler.</strong> <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> ve releases.open-design.ai üzerinden macOS (Apple Silicon ve Intel x64) ve Windows (yükleyici ve taşınabilir).</li>
      </ul>
      <p>Tam liste 405 PR'a ulaşıyor. <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub'daki sürüm notları</a> geri kalanını içeriyor.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Open Design'ı indirin</a>.</p>
  ...
  uk:
    ...
    bodyHtml: |
      ...
      <p>Якщо вам потрібна розгорнута версія, її містять <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">примітки до релізу на GitHub</a>. Цей допис — коротка версія: що змінилося під капотом, що з цим можна зробити вже сьогодні і з чого почати.</p>
      ...
      <ul>
        ...
        <li><strong>Збірки для кожного десктопу.</strong> macOS (Apple Silicon та Intel x64) і Windows (інсталятор і портативна версія) через <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">GitHub Releases</a> та releases.open-design.ai.</li>
      </ul>
      <p>Повний перелік налічує 405 PR. Решту містять <a href="https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0">примітки до релізу на GitHub</a>.</p>
      ...
      <p><a href="https://github.com/Aqu-210L/Z-design/releases">Завантажити Open Design</a>.</p>
...
If you want the long version, the [release notes on GitHub](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0) have it. This post is the short version: what changed under the hood, what you can do with it today, and where to start.
...
- **Builds for every desktop.** macOS (Apple Silicon and Intel x64) and Windows (installer and portable) via [GitHub Releases](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0) and releases.open-design.ai.

The full list runs to 405 PRs. The [release notes on GitHub](https://github.com/Aqu-210L/Z-design/releases/tag/open-design-v0.10.0) carry the rest.
...
[Download Open Design](https://github.com/Aqu-210L/Z-design/releases).
