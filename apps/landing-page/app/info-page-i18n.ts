...
const QUICKSTART_CODE = {
  install: 'git clone https://github.com/Aqu-210L/Z-design\ncd open-design\npnpm install',
...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      ...
      maintainerBody:
        'Open Design is developed in the open at github.com/Aqu-210L/Z-design and released under the Apache-2.0 license. Issues, RFCs, and roadmap conversations happen on GitHub Issues and Discord.',
    ...
    claudeAlternative: {
      ...
      faq: [
        ...
        { name: 'Who builds and maintains Open Design?', text: 'The project lives at github.com/Aqu-210L/Z-design and is Apache-2.0.' },
      ],
    ...
    alternatives: {
      lovable: {
        ...
        faq: [
          ...
          { name: 'Is Open Design really open source?', text: 'Yes. It lives at github.com/Aqu-210L/Z-design under Apache-2.0 and is self-hostable.' },
        ...
        rich: {
          ...
          heroCtaActions: [
            ...
            { label: 'Star on GitHub', href: 'https://github.com/Aqu-210L/Z-design', variant: 'ghost', external: true },
            { label: 'Download the desktop app', href: 'https://github.com/Aqu-210L/Z-design/releases', variant: 'ghost', external: true },
          ],
          heroImage: {
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    maintainerBody:
      'Open Design 在 github.com/Aqu-210L/Z-design 公开开发，并以 Apache-2.0 发布。Issue、RFC 和路线图讨论都在 GitHub Issues 与 Discord 进行。',
  ...
  claudeAlternative: {
    ...
    faq: [
      ...
      { name: '谁在构建和维护 Open Design？', text: '项目位于 github.com/Aqu-210L/Z-design，许可证为 Apache-2.0。' },
    ],
    ctaTitle: '三条命令切换。',
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    maintainerBody:
      'Open Design 在 github.com/Aqu-210L/Z-design 公開開發，並以 Apache-2.0 發布。Issue、RFC 與路線圖討論都在 GitHub Issues 與 Discord 進行。',
  ...
  claudeAlternative: {
    ...
    faq: [
      ...
      { name: '誰在構建和維護 Open Design？', text: '專案位於 github.com/Aqu-210L/Z-design，授權為 Apache-2.0。' },
    ],
    ctaTitle: '三條命令切換。',
