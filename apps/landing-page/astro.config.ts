...
const site = process.env.ZD_LANDING_SITE ?? 'https://open-design.ai';
// Staging / PR-preview builds set ZD_LANDING_NOINDEX=1. Resolved here (config
...
const landingNoindex = process.env.ZD_LANDING_NOINDEX === '1';
...
export default defineConfig({
  ...
  vite: {
    define: {
      // Staging / PR-preview builds set ZD_LANDING_NOINDEX=1. SeoHead reads
