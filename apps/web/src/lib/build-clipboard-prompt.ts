...
import type { Project } from '@z-design/contracts';
...
You're picking up an Z-Design project mid-flight in a fresh \`claude\` CLI session. Run \`claude\` at the working directory below; the design intent is captured in \`DESIGN.md\` at the project root.
