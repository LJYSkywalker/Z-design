...
// Map the BYOK transport protocol to the tracking provider id. GLM is the
// sole BYOK protocol for Z-Design, so this resolves to the 'glm' bucket;
// undefined falls back to the CLI catch-all `'other'`.
