...
// headers (see @z-design/contracts/analytics).

import type { AnalyticsClientType } from '@z-design/contracts/analytics';
import { detectZDesignHostClientType } from '@z-design/host';

const ANONYMOUS_ID_KEY = 'z-design:analytics.anonymous_id';
const SESSION_ID_KEY = 'z-design:analytics.session_id';
const RUN_TURN_INDEX_KEY = 'z-design:analytics.run_turn_index';
...
// Desktop packaged builds install the Z-Design host bridge so the
...
export function detectClientType(): AnalyticsClientType {
  ...
  return detectZDesignHostClientType();
}
