    ...
    <div className={`mcp-oauth-control${connected ? ' connected' : ''}`}>
        ...
        {connected ? (
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                Z-Design is listening for the callback in the background.
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                ...
                Grok image, video, and TTS in Z-Design — no API key
                needed.
              </span>
            </span>
          </>
      ...
      {isAwaiting ? (
        <div className="xai-oauth-warning" role="status">
          ...
          authorization is still being delivered to Z-Design in the
