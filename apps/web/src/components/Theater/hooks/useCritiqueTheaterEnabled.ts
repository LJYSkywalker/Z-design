...
const TOGGLE_EVENT = 'z-design:critique-theater-toggle';
 ...
 *
 * Source of truth is the existing `z-design:config` localStorage
 ...
 *   2. A same-tab `z-design:critique-theater-toggle` CustomEvent so
