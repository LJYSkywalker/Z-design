...
import type { ProjectKind, ProjectMetadata } from '@z-design/contracts';
import type { DefaultScenarioPluginId } from '@z-design/contracts';
...
export const HOME_HERO_CHIPS: ReadonlyArray<HomeHeroChip> = [
  ...
  },
  {
    ...
    icon: 'edit',
    group: 'migrate',
    hint: 'Author a reusable Z-Design plugin and add it to My plugins.',
