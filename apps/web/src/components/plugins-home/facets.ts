...
import { resolveLocalizedText, type InstalledPluginRecord } from '@z-design/contracts';
...
const PRIMARY_CATEGORIES: readonly CategoryDef[] = [
  {
    slug: 'prototype',
    label: 'Prototype',
    starterPrompt: 'Create an Z-Design plugin that generates an interactive prototype from a product brief.',
    test: (record) => byMode('prototype')(record) && !isLiveArtifactPlugin(record),
  },
  {
    slug: 'live-artifact',
    label: 'Live Artifact',
    starterPrompt: 'Create an Z-Design plugin that generates a live artifact with refreshable, data-aware UI.',
    test: isLiveArtifactPlugin,
  },
  {
    slug: 'deck',
    label: 'Slides',
    starterPrompt: 'Create an Z-Design plugin that generates a polished slide deck from a narrative brief.',
    test: byMode('deck'),
  },
  {
    slug: 'image',
    label: 'Image',
    starterPrompt: 'Create an Z-Design plugin that generates image assets from structured creative direction.',
    test: byMode('image'),
  },
  {
    slug: 'video',
    label: 'Video',
    starterPrompt: 'Create an Z-Design plugin that generates video prompts, storyboards, or render-ready motion artifacts.',
    test: isVideoPlugin,
  },
  {
    slug: 'hyperframes',
    label: 'HyperFrames',
    starterPrompt: 'Create an Z-Design plugin that generates a HyperFrames-ready motion composition.',
    test: isHyperFramesPlugin,
  },
  {
    slug: 'audio',
    label: 'Audio',
    starterPrompt: 'Create an Z-Design plugin that generates audio, voice, or sound-design assets from a brief.',
    test: byMode('audio'),
  },
];
...
const SUBCATEGORIES: readonly SubcategoryDef[] = [
  {
    ...
    label: 'Dashboards',
    starterPrompt: 'Create an Z-Design prototype plugin for business systems, admin panels, or analytics dashboards.',
    test: byAnySlug(
      'dashboard',
      'admin-panel',
      'analytics',
  ...
  },
  {
    ...
    slug: 'app-prototypes',
    label: 'Apps',
    starterPrompt: 'Create an Z-Design prototype plugin for multi-screen apps, onboarding, or task-productivity flows.',
    test: byAnySlug(
      'mobile',
      'app',
      'mobile-app',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design prototype plugin for landing pages, marketing sites, pricing pages, or campaign pages.',
    test: byAnySlug(
      'landing',
      'landing-page',
      'saas-landing',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design prototype plugin for developer tools, engineering workflows, docs, or code collaboration.',
    test: byAnySlug(
      'engineering',
      'docs',
      'documentation',
  ...
  },
  {
    ...
    slug: 'docs-reports',
    label: 'Docs / reports',
    starterPrompt: 'Create an Z-Design prototype plugin for reports, documents, case studies, specs, invoices, or resumes.',
    test: byAnySlug(
      'report',
      'financial-report',
      'finance-report',
  ...
  },
  {
    ...
    slug: 'brand-design',
    label: 'Brand / design',
    starterPrompt: 'Create an Z-Design prototype plugin for brand pages, visual exploration, design reviews, or mockups.',
    test: byAnySlug(
      'design',
      'design-review',
      'design-audit',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design deck plugin for fundraising, business plans, investor decks, or strategic narratives.',
    test: byAnySlug(
      'pitch-deck',
      'pitch',
      'fundraising',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design deck plugin for courses, training materials, workshops, or classroom slides.',
    test: byAnySlug(
      'course-module',
      'course-slides',
      'training-deck',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design deck plugin for weekly reports, management briefings, white papers, or business reviews.',
    test: byAnySlug(
      'weekly-report',
      'status-update',
      'team-report',
  ...
  },
  {
    ...
    slug: 'product-sales',
    label: 'Product / sales',
    starterPrompt: 'Create an Z-Design deck plugin for product launches, sales enablement, feature reveals, or customer pitches.',
    test: byAnySlug(
      'product-launch',
      'launch-deck',
      'feature-reveal',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design deck plugin for technical presentations, architecture walkthroughs, or dev workflow talks.',
    test: byAnySlug(
      'engineering',
      'tech-sharing',
      'tech-talk',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design deck plugin for creative, editorial, brand, social, or visual storytelling decks.',
    test: byAnySlug(
      'marketing',
      'editorial',
      'zhangzara',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design image plugin for product UI mockups, game UI, product cards, or interface showcases.',
    test: byAnySlug(
      'app-web-design',
      'game-ui',
      'ui',
  ...
  },
  {
    ...
    slug: 'brand-visuals',
    label: 'Brand / logo',
    starterPrompt: 'Create an Z-Design image plugin for logos, brand visuals, typography-led posters, or visual systems.',
  ...
  },
  {
    ...
    label: 'Storyboards',
    starterPrompt: 'Create an Z-Design image plugin for storyboards, choreography breakdowns, pose references, or motion planning sheets.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design image plugin for social posts, infographics, explainers, or content graphics.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design image plugin for avatars, portraits, identity photos, or character headshots.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design image plugin for illustrations, anime, fantasy scenes, 3D renders, or style-transfer prompts.',
    test: byAnySlug(
      'illustration',
      'anime',
      'fantasy',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design video plugin for motion graphics, VFX, title frames, animation, or logo/outro sequences.',
    test: byAnySlug(
      'motion-graphics',
      'vfx',
      'frame',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design video plugin for short-form social clips, vertical video, TikTok-style captions, or dance trends.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design video plugin for product promos, advertising, brand sizzle reels, or marketing cuts.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design video plugin for data explainers, animated charts, maps, diagrams, or flow walkthroughs.',
  ...
  },
  {
    ...
    starterPrompt: 'Create an Z-Design video plugin for cinematic scenes, story sequences, anime/action shots, or fantasy clips.',
    test: byAnySlug(
      'cinematic',
      'fantasy',
      'action',
