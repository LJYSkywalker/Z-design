...
import type { ZDesignGithubRepoResponse } from '@z-design/contracts';

const API = '/api/github/open-design';
const REPO = 'https://github.com/Aqu-210L/Z-design';
const LS_KEY = 'z-design:gh-stars';
const FAILURE_LS_KEY = 'z-design:gh-stars:last-failure';
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const data = (await res.json()) as Partial<ZDesignGithubRepoResponse>;
