...
import type { ZDesignDiscordPresenceResponse } from '@z-design/contracts';

const API = '/api/community/discord';
const LS_KEY = 'z-design:discord-presence';
...
function cacheFromPayload(payload: Partial<ZDesignDiscordPresenceResponse>): CachedPresence | null {
  if (
