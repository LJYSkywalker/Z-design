...
const AMR_REMINDER_SEEN_KEY = 'z-design:inline-amr-cli-reminder-seen:v2';
...
export function InlineModelSwitcher({
  ...
  useEffect(() => {
    ...
    // GLM is the sole protocol; the legacy azure/ollama early-returns (no
    // public model list) and the AIHubMix key-less fetch no longer apply. GLM
    // needs an API key to fetch its model list.
