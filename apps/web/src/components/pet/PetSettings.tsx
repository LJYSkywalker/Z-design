...
export function PetSettings({ cfg, setCfg }: Props) {
  ...
  // who've resized or recompressed a hatched pet outside Z-Design.
  ...
  const hatchPrompt = useMemo(() => {
    ...
    return [
      ...
      '',
      'When the spritesheet is saved, tell me the absolute path so I can import it into Z-Design via Settings → Pets → Import Codex sprite.',
    ].join('\n');
  }, [hatchConcept]);
