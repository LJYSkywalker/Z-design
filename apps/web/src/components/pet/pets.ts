...
const DEFAULT_PET_ACCENT = '#0881f0';
...
function resolveCustomPet(c: PetCustom): ResolvedPet {
  return {
    ...
    glyph: c.glyph?.trim() || '🦄',
    accent: c.accent?.trim() || DEFAULT_PET_ACCENT,
...
// Keep these brand-neutral and product-relevant to Z-Design.
