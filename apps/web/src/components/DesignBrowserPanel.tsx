...
import type { TrackingReferenceBoardCategory } from '@z-design/contracts/analytics';
...
export function browserUsePrompt(action: BrowserUseAction, context: BrowserUsePromptContext = {}): string {
  ...
  return [
    '@agent-browser',
    '',
    'Use the selected Z-Design Browser tab as the bound target.',
    'Browser tab context:',
    `- tab: ${tabLabel}`,
    `- title: ${title}`,
    `- url: ${url}`,
...
export function DesignBrowserPanel({
  ...
  const t = useT();
  const desktopHostAvailable = isZDesignHostAvailable();
    ...
    <div className="db-start">
      <div className="db-start-hero">
        <div className="db-start-hero-copy">
          <div className="db-kicker">Z-Design browser</div>
