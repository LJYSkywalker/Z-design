...
const PREFERRED_EDITOR_KEY = 'z-design:preferred-editor';
const PREFERRED_FRAMEWORK_KEY = 'z-design:handoff-framework';
...
const FALLBACK_CLI_TARGETS: CliTarget[] = [
  { id: 'amr', name: 'Z-Design AMR', bin: 'vela', available: false },
