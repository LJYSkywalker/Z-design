// Trigger prompt for the post-completion "Share to Z-Design" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Z-Design plugin so I can install it into My plugins and open a PR to the Z-Design community catalog.',
  '',
  ...
  '- z-design.json with valid metadata: specVersion, name, version, description, mode, task kind, inputs, plus any pipeline / context references the workflow needs',
  ...
  '- **Z-Design PR** — opens a draft PR against `nexu-io/open-design` for the community catalog.',
  '',
