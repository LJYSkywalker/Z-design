...
import { Dialog } from '@z-design/components';
import {
...
const PLUGIN_SHARE_DETAILS: Record<PluginShareAction, {
  ...
  'publish-github': {
    ...
    fallbackDescription:
      'Creates a public GitHub repository for this local Z-Design plugin.',
    confirmLabel: 'Start publishing',
    steps: [
      'Create a new Z-Design project for the publish workflow.',
  ...
  'contribute-z-design': {
    eyebrow: 'Z-Design pull request',
    fallbackTitle: 'Contribute Plugin to Z-Design',
    fallbackDescription:
      'Opens a pull request that adds this plugin to the Z-Design community catalog.',
    confirmLabel: 'Start contribution',
    steps: [
      'Create a new Z-Design project for the contribution workflow.',
      'Copy this plugin into that project as isolated source context.',
...
export function PluginsView({
  ...
  useEffect(() => {
    void refresh();
    window.addEventListener('z-design:plugins-changed', refresh);
    return () => window.removeEventListener('z-design:plugins-changed', refresh);
  }, []);
          ...
          {installedRecord ? (
            <section className="plugin-details-modal__section">
              ...
              <p className="plugin-details-modal__section-hint">
                This official catalog entry is bundled with Z-Design and is ready to use.
              </p>
            </section>
          ) : (
            <section className="plugin-details-modal__section">
      ...
      >
        ...
        <div className="plugins-import-modal__body">
          ...
          {kind === 'zip' ? (
            <FileImportPanel
              title="Upload zip"
              body="Choose a .zip archive containing z-design.json, SKILL.md, or .claude-plugin/plugin.json."
