...
export const IT_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      'Voce UI/UX Pro Max solo a catalogo. I template upstream completi, i dati e il flusso di ricerca non sono inclusi in Z-Design.',
    examplePrompt:
