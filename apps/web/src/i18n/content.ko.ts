...
export const KO_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      '카탈로그 전용 UI/UX Pro Max 항목입니다. 전체 업스트림 템플릿, 데이터, 검색 워크플로는 Z-Design에 포함되어 있지 않습니다.',
    examplePrompt:
