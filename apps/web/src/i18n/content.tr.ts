...
export const TR_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      'Yalnızca katalog UI/UX Pro Max girişi. Tam kaynak şablonlar, veriler ve arama iş akışı Z-Design\'a dahil değildir.',
    examplePrompt:
