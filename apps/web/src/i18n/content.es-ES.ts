...
export const ES_ES_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'agent-browser': {
    description:
      'CLI de automatización de navegador para agentes de IA. Úsalo cuando el usuario necesite inspeccionar,\nprobar o automatizar el comportamiento del navegador: navegar por páginas, rellenar formularios,\nhacer clic en botones, tomar capturas de pantalla, extraer datos de páginas, leer el contexto\nseleccionado de pestañas del navegador en Z-Design, probar aplicaciones web, hacer dogfooding de\nlas previsualizaciones de Z-Design, QA, búsqueda de errores o revisar la calidad de la aplicación. Prioriza las URL\nde previsualización locales de Z-Design salvo que el usuario pida explícitamente navegación externa.',
    examplePrompt:
  ...
  'ui-ux-pro-max': {
    description:
      'Entrada de UI/UX Pro Max solo de catálogo. Las plantillas, datos y flujo de búsqueda originales completos no se incluyen en Z-Design.',
    examplePrompt:
