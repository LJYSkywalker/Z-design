...
export const FR_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'agent-browser': {
    examplePrompt:
      'Vérifiez la preview locale Z-Design avec agent-browser : démarrez ou connectez Chrome CDP, ouvrez http://127.0.0.1:17573/, puis rapportez le titre, l’URL, le texte visible et enregistrez un screenshot.',
    description:
      'Automatisation navigateur pour valider la preview locale Z-Design. Se connecte à un endpoint Chrome CDP vérifié, lit l’état rendu de la page, peut cliquer/saisir si nécessaire et enregistre un screenshot.',
  },
  'blog-post': {
    examplePrompt:
  ...
  'open-design-landing': {
    examplePrompt:
      'Concevez la landing page marketing Z-Design dans le style Atelier Zero / Monocle — canvas papier chaud, collage surréaliste plâtre + architecture, grande typographie display serif italique mixée, chiffres romains comme marqueurs de sections et un seul accent corail.',
  },
  'open-design-landing-deck': {
    examplePrompt:
      'Créez le pitch deck Z-Design dans le style Atelier Zero — cover avec hero plate, séparateurs de section en chiffres romains, slide stats (31 Skills · 72 systèmes · 12 CLIs), citation client, CTA et end-card mega italic-serif. Pagination horizontal-swipe comme un magazine imprimé.',
    description:
