...
export const HU_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      'Csak katalógusos UI/UX Pro Max bejegyzés. A teljes upstream sablonok, adatok és keresési munkafolyamat nincs csomagolva az Z-Designba.',
    examplePrompt:
