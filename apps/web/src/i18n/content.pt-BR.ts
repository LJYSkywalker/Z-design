...
export const PT_BR_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      'Entrada UI/UX Pro Max somente de catálogo. Os templates upstream completos, os dados e o fluxo de busca não estão incluídos no Z-Design.',
    examplePrompt:
