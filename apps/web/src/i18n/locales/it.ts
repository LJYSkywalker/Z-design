...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di Z-Design — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.onboardingCreateBody': 'Descrivi il sito, l\'app, la presentazione, l\'immagine o il video che desideri. Z-Design creerà un progetto e manterrà il lavoro modificabile.',
  ...
  'settings.onboardingGateTooltipAmr': 'I passaggi successivi vengono eseguiti tramite IA — accedi a Z-Design AMR per continuare.',
  ...
  'settings.agentInstall.pathHint': 'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Z-Design (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth': 'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Z-Design.',
  ...
  'settings.mcpServerHint': 'Esponi Z-Design come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Z-Design',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Z-Design',
  'settings.privacyConsentLead': 'Z-Design può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'settings.mcpHint': 'Consenti agli agent di coding (Cursor, Claude Code, VS Code…) di leggere direttamente i tuoi progetti Z-Design.',
  'settings.mcpDaemonError': 'Impossibile raggiungere il daemon locale per risolvere i percorsi di installazione ({error}). Assicurati che Z-Design sia in esecuzione, quindi riapri questo pannello.',
  'settings.mcpBuildDaemon': 'Compila prima il daemon.',
  'settings.mcpNodeMissing': 'Il binario Node è mancante.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js è mancante. Esegui `pnpm --filter @z-design/daemon build` e aggiorna.',
  ...
  'settings.mcpCapabilityDefault': 'Utilizzare per impostazione predefinita il progetto e il file che hai aperto in Z-Design, così puoi dire "build this in my app" senza dover ripetere quale design.',
  'settings.mcpRunningNote': 'Z-Design deve essere in esecuzione affinché le chiamate agli strumenti MCP abbiano successo. Se hai avviato il tuo coding agent prima di aprire Z-Design, riavvia l\'agent in modo che possa raggiungere il daemon attivo.',
  ...
  'entry.discordAria': 'Unisciti al Discord di Z-Design',
  'entry.discordAriaWithOnline': 'Unisciti al Discord di Z-Design - {online}',
  ...
  'homeHero.subtitlePrefix': 'Il workspace di design agentico nativo per GLM.',
  ...
  'homeHero.chip.createPluginHint': 'Crea un plugin Z-Design riutilizzabile e aggiungilo a I miei plugin.',
  ...
  'handoff.promptIntro': 'Continua da questa cartella di progetto locale di Z-Design:',
  ...
  'pluginsHome.subtitle': 'Workflow di Z-Design pronti all\'uso inclusi in questo runtime. Scegline uno per caricare un prompt iniziale oppure esplora il registry per altro.',
  ...
  'pluginsHome.emptyCatalog': 'Il catalogo è vuoto. I plugin inclusi sono forniti con Z-Design e dovrebbero comparire qui automaticamente — prova a riavviare il daemon se il problema persiste.',
  ...
  'pluginCard.contributeAria': 'Contribuisci con {title} a Z-Design',
  'pluginCard.contributeTitle': 'Contribuisci con il plugin a Z-Design tramite una pull request',
  ...
  'integrations.lede': 'Collega sistemi esterni, porta gli strumenti MCP nel loop del tuo agent e usa Z-Design da altri IDE, script e automazioni.',
  ...
  'mcpClient.daemonError': 'Impossibile raggiungere il daemon locale. Assicurati che Z-Design sia in esecuzione, quindi riapri questo pannello.',
  'mcpClient.saveFailed': 'Salvataggio non riuscito. Verifica che il daemon sia in esecuzione e riprova.',
  'useEverywhere.modalAria': 'Usa Z-Design ovunque',
  'useEverywhere.modalTitle': 'Usa Z-Design ovunque',
  'useEverywhere.modalSubtitle': 'Integra Z-Design in qualsiasi IDE, agent o script — CLI, HTTP, MCP e Skill. Usa “Copia la guida per un agent” e incollala in Claude Code, Codex, Cursor, openclaw o hermes per configurare tutto.',
  ...
  'useEverywhere.section.overview.heading': 'Z-Design funziona ovunque lavori il tuo agent',
  'useEverywhere.section.overview.intro': 'Z-Design è molto più di una finestra — è un daemon locale con privilegi (`od`) più un registro di Skill + Design System + Atoms. Una volta in esecuzione sulla tua macchina, qualsiasi agent di codice (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, un tuo script) può avviare generazioni, ispezionare progetti e produrre artefatti di design attraverso quattro interfacce intercambiabili.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` per script headless, CI e automazione da shell.',
  'useEverywhere.section.overview.bullet2': 'Server MCP — collega Z-Design come server Model Context Protocol così che qualsiasi agent compatibile con MCP possa elencare skill, eseguire scenari e leggere artefatti.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skill — pacchetti `SKILL.md` pronti all\'uso (compatibili con Claude) che qualsiasi agent già presente nel tuo PATH può invocare senza Z-Design.',
  ...
  'useEverywhere.section.overview.footer': 'Per impostazione predefinita, il daemon scrive in `./.od/` (locale al progetto). Imposta `ZD_DATA_DIR=~/.open-design` per condividere i dati tra progetti.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Controlla Z-Design da qualsiasi shell',
  ...
  'useEverywhere.section.mcp.heading': 'Esponi Z-Design come server MCP a qualsiasi coding agent',
  'useEverywhere.section.mcp.intro': 'Z-Design include un server Model Context Protocol (`od mcp`) che consente a qualsiasi client compatibile con MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — di scoprire gli strumenti di Z-Design (elenca skill, genera anteprime, genera media, esegui plugin) senza ricorrere manualmente alla shell. Il daemon pubblica uno snippet di installazione pronto da incollare tramite `GET /api/mcp/install-info` per ogni client principale.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Fissa `ZD_DATA_DIR` in modo che il processo MCP generato scriva nello stesso percorso già usato dal daemon (evita EPERM nei bundle delle app macOS pacchettizzate).',
  ...
  'useEverywhere.section.http.footer': 'I tipi TypeScript puri per ogni richiesta/risposta si trovano in `@z-design/contracts` — importali nel tuo script per il completamento automatico completo senza configurare un generatore.',
  'useEverywhere.section.skills.tab': 'Skill e headless',
  'useEverywhere.section.skills.heading': 'Skill pronte all\'uso per qualsiasi agent — anche senza Z-Design in esecuzione',
  'useEverywhere.section.skills.intro': 'Una Skill è una directory con un file `SKILL.md` compatibile con Claude (front-matter YAML + corpo). Z-Design estende il formato con il namespace `od:` (`mode`, `preview`, `design_system`, `inputs`, …) così che lo stesso artefatto possa essere usato sia all\'interno di Z-Design sia da un agent standard come Claude Code, Codex, openclaw o hermes. Il rilevamento segue una catena di precedenza così che i progetti possano sovrascrivere le proprie skill.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimale (front matter compatibile con Claude + extra di Z-Design)',
  ...
  'entry.githubStarAria': 'Assegna una star a Z-Design su GitHub',
  ...
  'newproj.locationDefault': 'Progetti Z-Design',
  ...
  'socialShare.zDesignSection': 'Condividi Z-Design',
  'socialShare.zDesignTitle': 'Z-Design su GitHub',
  'socialShare.zDesignText': 'Z-Design è uno spazio di lavoro open-source per creare, modificare, distribuire e consegnare artifact di design.',
  ...
  'socialShare.projectText': 'Creato con Z-Design: {title}. Visualizza l\'artifact distribuito e metti una stella al repo: {repo}',
  'socialShare.projectCopyText': 'Creato con Z-Design: {title}\n{url}\nRepo di Z-Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Chiedi a Z-Design di modificare {file}...',
  ...
  'chat.mode.design.solves': 'Usala quando vuoi che Z-Design generi file, aggiorni il workspace o trasformi un brief in deliverable multimodali.',
  ...
  'preview.shareTextDefault': 'Template Z-Design: {title}',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Z-Design sia in esecuzione e riprova.',
  ...
  'designFiles.usefulInfoTip7': 'Ti piace Z-Design? Lascia una stella su GitHub.',
  ...
  'assistant.shareToZDesign': 'Condividi su Z-Design',
  'assistant.shareToZDesignBusy': 'Preparazione pacchetto…',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Z-Design — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Z-Design — nessun download necessario.',
  ...
  'settings.projectLocationsDescription': 'Aggiungi basi di lavoro che possono contenere più cartelle di progetti Z-Design. I nuovi progetti vengono salvati come una cartella nella base selezionata.',
  ...
  'settings.customInstructionsHint': 'Istruzioni fisse che ZDesign deve seguire in ogni chat. Salva fatti, preferenze e contesto del progetto come memorie.',
  ...
  'settings.memoryStarterProjectDesc': 'Z-Design v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'Z-Design {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. Z-Design si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.payloadReadyGeneric': 'A new Z-Design update is ready. Z-Design will close and restart automatically.',
  'updater.payloadReadyVersion': 'Z-Design {version} is ready. Z-Design will close and restart automatically.',
  'updater.quitButton': 'Esci da Z-Design',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma Z-Design non è riuscito a uscire. Esci da Z-Design prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. Z-Design si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'Z-Design {version} è pronto. Z-Design si chiuderà e aprirà il programma di installazione.',
  ...
  'dsManager.createBody': 'Insegna a Z-Design il tuo brand, prodotto, codice, asset e riferimenti di design.',
  ...
  'settings.customInstructionsDesc': 'Istruzioni fisse che Z-Design segue in ogni chat. Non sono memorie salvate; usa Memoria per fatti, preferenze e contesto del progetto.',
