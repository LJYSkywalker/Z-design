...
export const ar: Dict = {
  ...
  'chat.amrCard.switchBody': 'بدِّل إلى خدمة نماذج AMR الرسمية من Z-Design — لا حاجة لإعداد مفتاح API. بعد تسجيل الدخول والتفويض والشحن، ستُعاد محاولة هذه المهمة تلقائيًا.',
  ...
  'settings.onboardingCreateBody': 'صِف الموقع أو التطبيق أو العرض التقديمي أو الصورة أو الفيديو الذي تريده. سيُنشئ Z-Design مشروعًا ويُبقي العمل قابلاً للتحرير.',
  ...
  'settings.onboardingCloudTitle': 'تسجيل الدخول إلى Z-Design',
  'settings.onboardingCloudBody': 'سجّل الدخول وابدأ التصميم فورًا باستخدام الذكاء الاصطناعي السحابي، دون أي إعداد معقّد.',
  'settings.onboardingCloudSignIn': 'تسجيل الدخول إلى Z-Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'الخطوات التالية تعمل بالذكاء الاصطناعي — سجّل الدخول إلى Z-Design AMR للمتابعة.',
  ...
  'settings.agentInstall.pathHint': 'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Z-Design (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth': 'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Z-Design.',
  ...
  'settings.mcpServerHint': 'كشف Z-Design كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'settings.privacyHint': 'البيانات التي تتم مشاركتها مع فريق Z-Design',
  'settings.privacyConsentKicker': 'ساعدنا في تحسين Z-Design',
  'settings.privacyConsentLead': 'يمكن لـ Z-Design مشاركة بيانات الاستخدام مع فريقنا لمساعدتنا على التحسين. يشمل ذلك:',
  ...
  'settings.mcpHint': 'اسمح لوكلاء البرمجة (Cursor، Claude Code، VS Code…) بقراءة مشاريع Z-Design الخاصة بك مباشرةً.',
  'settings.mcpDaemonError': 'تعذّر الوصول إلى الـ daemon المحلي لتحديد مسارات التثبيت ({error}). تأكد من أن Z-Design قيد التشغيل، ثم أعد فتح هذه اللوحة.',
  'settings.mcpBuildDaemon': 'قم ببناء الـ daemon أولًا.',
  'settings.mcpNodeMissing': 'ملف Node التنفيذي مفقود.',
  'settings.mcpBuildHint': 'الملف apps/daemon/dist/cli.js مفقود. شغّل `pnpm --filter @z-design/daemon build` ثم حدّث.',
  ...
  'settings.mcpCapabilityDefault': 'الاعتماد افتراضيًا على المشروع والملف المفتوحَين في Z-Design، حتى تتمكن من قول "ابنِ هذا في تطبيقي" دون إعادة تحديد التصميم المقصود.',
  'settings.mcpRunningNote': 'يجب أن يكون Z-Design قيد التشغيل حتى تنجح استدعاءات أدوات MCP. إذا بدأت تشغيل وكيل البرمجة قبل فتح Z-Design، فأعد تشغيل الـ Agent ليتمكن من الوصول إلى الـ daemon النشط.',
  ...
  'entry.discordAria': 'انضم إلى Discord الخاص بـ Z-Design',
  'entry.discordAriaWithOnline': 'انضم إلى Discord الخاص بـ Z-Design - {online}',
  ...
  'homeHero.subtitlePrefix': 'مساحة عمل التصميم الوكيلية المدعومة بـ GLM.',
  ...
  'homeHero.chip.createPluginHint': 'أنشئ إضافة Z-Design قابلة لإعادة الاستخدام وأضِفها إلى إضافاتي.',
  ...
  'handoff.promptIntro': 'المتابعة من مجلد مشروع Z-Design المحلي هذا:',
  ...
  'pluginsHome.subtitle': 'سير عمل Z-Design جاهز للاستخدام ومرفق بهذا التشغيل. اختر واحدًا لتحميل موجّه بدء، أو تصفّح السجل للمزيد.',
  'pluginsHome.browseRegistry': 'تصفح السجل',
  'pluginsHome.count': '{filtered} من {total}',
  'pluginsHome.loadingCatalog': 'جارٍ تحميل الكتالوج…',
  'pluginsHome.emptyCatalog': 'الكتالوج فارغ. تأتي الإضافات المُجمَّعة مع Z-Design ومن المفترض أن تظهر هنا تلقائيًا — جرّب إعادة تشغيل الـ daemon إذا استمرت هذه المشكلة.',
  ...
  'pluginCard.contributeAria': 'المساهمة بـ {title} في Z-Design',
  'pluginCard.contributeTitle': 'المساهمة بالإضافة في Z-Design عبر طلب سحب (PR)',
  ...
  'integrations.lede': 'اربط الأنظمة الخارجية، وأدخِل أدوات MCP إلى حلقة الـ Agent الخاصة بك، واستخدم Z-Design من بيئات تطوير وبرامج نصية وعمليات أتمتة أخرى.',
  ...
  'mcpClient.daemonError': 'تعذّر الوصول إلى الخدمة المحلية. تأكّد من أن Z-Design قيد التشغيل، ثم أعِد فتح هذه اللوحة.',
  'mcpClient.saveFailed': 'فشل الحفظ. تحقّق من أن الخدمة قيد التشغيل وحاول مرة أخرى.',
  'useEverywhere.modalAria': 'استخدم Z-Design في كل مكان',
  'useEverywhere.modalTitle': 'استخدم Z-Design في كل مكان',
  'useEverywhere.modalSubtitle': 'أدرِج Z-Design في أي IDE أو Agent أو سكربت — CLI وHTTP وMCP وSkills. استخدم “Copy guide for an agent” والصقه في Claude Code أو Codex أو Cursor أو openclaw أو hermes لإعداد كل شيء.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — حزم `SKILL.md` جاهزة للاستخدام (متوافقة مع Claude) يمكن لأي Agent موجود مسبقًا على الـ PATH استدعاؤها دون الحاجة إلى Z-Design على الإطلاق.',
  ...
  'useEverywhere.section.overview.footer': 'يكتب الـ daemon إلى `./.od/` (محلي للمشروع) افتراضيًا. عيّن `ZD_DATA_DIR=~/.open-design` لمشاركة البيانات عبر المشاريع.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'تشغيل Z-Design من أي shell',
  ...
  'useEverywhere.section.mcp.heading': 'اجعل Z-Design متاحًا كخادم MCP لأي coding agent',
  'useEverywhere.section.mcp.intro': 'يأتي Z-Design مع خادم Model Context Protocol (`od mcp`) يتيح لأي عميل يدعم MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اكتشاف أدوات Z-Design (سرد المهارات، عرض المعاينات، توليد الوسائط، تشغيل الإضافات) دون استخدام الـ shell يدويًا. ينشر الـ daemon مقتطف تثبيت جاهزًا للصق عبر `GET /api/mcp/install-info` لكل عميل رئيسي.',
  ...
  'useEverywhere.section.mcp.bullet4': 'يثبّت `ZD_DATA_DIR` بحيث تكتب عملية MCP المُنشأة إلى المكان نفسه الذي يستخدمه الـ daemon بالفعل (يتجنّب EPERM في حزم تطبيقات macOS المُحزَّمة).',
  ...
  'useEverywhere.section.mcp.footer': 'في تطبيق Z-Design، افتح الإعدادات → التكاملات لنسخ أمر تثبيت خاص بكل عميل (Cursor، Claude Code، Antigravity، VS Code) بدلًا من تحرير JSON يدويًا.',
  ...
  'useEverywhere.section.http.footer': 'تتوفر أنواع TypeScript خالصة لكل طلب/استجابة في `@z-design/contracts` — استوردها في سكربتك للحصول على إكمال تلقائي كامل دون تهيئة مُولِّد.',
  'useEverywhere.section.skills.tab': 'المهارات والوضع بدون واجهة',
  'useEverywhere.section.skills.heading': 'مهارات Skills جاهزة للاستخدام لأي Agent — حتى دون تشغيل Z-Design',
  'useEverywhere.section.skills.intro': 'المهارة هي دليل يحتوي على `SKILL.md` متوافق مع Claude (مقدّمة YAML + متن). يوسّع Z-Design التنسيق بفضاء الأسماء `od:` (`mode`، `preview`، `design_system`، `inputs`، …) بحيث يمكن استخدام المخرَج نفسه داخل Z-Design ومن قِبل Agent عادي مثل Claude Code أو Codex أو openclaw أو hermes. يتّبع الاكتشاف سلسلة أولوية بحيث يمكن للمشاريع تجاوز مهاراتها الخاصة.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md بحدّه الأدنى (front matter متوافق مع Claude + إضافات Z-Design)',
  ...
  'entry.githubStarAria': 'منح Z-Design نجمة على GitHub',
  ...
  'newproj.locationDefault': 'مشاريع Z-Design',
  ...
  'socialShare.zDesignSection': 'مشاركة Z-Design',
  'socialShare.zDesignTitle': 'Z-Design على GitHub',
  'socialShare.zDesignText': 'Z-Design هي مساحة عمل مفتوحة المصدر لإنشاء عناصر التصميم وتحريرها ونشرها وتسليمها.',
  ...
  'socialShare.projectText': 'تم الإنشاء باستخدام Z-Design: {title}. اعرض العنصر المنشور وامنح نجمة للمستودع: {repo}',
  'socialShare.projectCopyText': 'تم الإنشاء باستخدام Z-Design: {title}\n{url}\nمستودع Z-Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'اطلب من Z-Design تعديل {file}...',
  ...
  'chat.mode.design.solves': 'استخدمه عندما تريد من Z-Design إنشاء ملفات، تحديث مساحة العمل، أو تحويل موجز إلى مخرجات متعددة الوسائط جاهزة.',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Z-Design ثم أعد المحاولة.',
  ...
  'designFiles.usefulInfoTip7': 'أعجبك Z-Design؟ امنحنا نجمة على GitHub.',
  ...
  'assistant.shareToZDesign': 'المشاركة على Z-Design',
  'assistant.shareToZDesignBusy': 'جارٍ تجهيز الحزمة…',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع Z-Design - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع Z-Design - لا حاجة للتحميل.',
  ...
  'settings.projectLocationsDescription': 'أضف قواعد عمل يمكن أن تحتوي على عدة مجلدات مشاريع Z-Design. تُحفظ المشاريع الجديدة كمجلد داخل القاعدة المحددة.',
  ...
  'settings.customInstructionsHint': 'تعليمات ثابتة يجب أن يتبعها ZDesign في كل محادثة. احفظ الحقائق والتفضيلات وسياق المشروع كذكريات.',
  ...
  'settings.memoryStarterProjectDesc': 'Z-Design v0.5 — محرر تصميم يعمل بالمحادثة',
  ...
  'updater.availableBody': 'Z-Design {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء Z-Design لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء Z-Design',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء Z-Design. أغلق Z-Design قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق Z-Design وفتح المثبت.',
  'updater.readyVersion': 'Z-Design {version} جاهز. سيتم إغلاق Z-Design وفتح المثبت.',
  ...
  'dsManager.createBody': 'علّم Z-Design علامتك التجارية ومنتجك وكودك وأصولك ومراجع التصميم الخاصة بك.',
  ...
  'settings.customInstructionsDesc': 'تعليمات ثابتة يتبعها Z-Design في كل محادثة. هذه ليست ذكريات محفوظة؛ استخدم الذاكرة للحقائق والتفضيلات وسياق المشروع.',
