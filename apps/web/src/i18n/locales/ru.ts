...
export const ru: Dict = {
  ...
  'chat.amrCard.switchBody': 'Переключитесь на официальный сервис моделей AMR от Z-Design — без настройки API-ключа. После входа, авторизации и пополнения это выполнение будет автоматически повторено.',
  ...
  'settings.onboardingCreateBody': 'Опишите сайт, приложение, презентацию, изображение или видео, которое вам нужно. Z-Design создаст проект и сохранит возможность редактирования работы.',
  ...
  'settings.onboardingCloudTitle': 'Войти в Z-Design',
  'settings.onboardingCloudBody': 'Войдите и сразу начните создавать с облачным ИИ — без сложных настроек.',
  'settings.onboardingCloudSignIn': 'Войти в Z-Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'Следующие шаги выполняются на ИИ — войдите в Z-Design AMR, чтобы продолжить.',
  ...
  'settings.agentInstall.pathHint': 'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Z-Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth': 'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Z-Design.',
  ...
  'settings.mcpServerHint': 'Откройте Z-Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'settings.privacyHint': 'Какие данные передаются команде Z-Design',
  'settings.privacyConsentKicker': 'Помогите нам улучшить Z-Design',
  'settings.privacyConsentLead': 'Z-Design может передавать данные об использовании нашей команде, чтобы помочь нам стать лучше. Сюда входят:',
  ...
  'settings.mcpHint': 'Позвольте агентам для кода (Cursor, Claude Code, VS Code…) напрямую читать ваши проекты Z-Design.',
  'settings.mcpDaemonError': 'Не удалось подключиться к локальному демону для определения путей установки ({error}). Убедитесь, что Z-Design запущен, затем снова откройте эту панель.',
  'settings.mcpBuildDaemon': 'Сначала соберите демон.',
  'settings.mcpNodeMissing': 'Отсутствует исполняемый файл Node.',
  'settings.mcpBuildHint': 'Файл apps/daemon/dist/cli.js отсутствует. Выполните `pnpm --filter @z-design/daemon build` и обновите.',
  ...
  'settings.mcpCapabilityDefault': 'По умолчанию использовать проект и файл, открытые в Z-Design, чтобы можно было сказать «собери это в моём приложении», не уточняя, о каком дизайне идёт речь.',
  'settings.mcpRunningNote': 'Для успешного выполнения вызовов инструментов MCP необходимо, чтобы Z-Design был запущен. Если вы запустили своего агента для кодинга до открытия Z-Design, перезапустите агент, чтобы он мог подключиться к работающему демону.',
  ...
  'entry.discordAria': 'Присоединиться к Discord-сообществу Z-Design',
  'entry.discordAriaWithOnline': 'Присоединиться к Discord-сообществу Z-Design — {online}',
  ...
  'homeHero.subtitlePrefix': 'Нативная агентная дизайн-платформа на GLM.',
  ...
  'homeHero.chip.createPluginHint': 'Создайте многоразовый плагин Z-Design и добавьте его в раздел «Мои плагины».',
  ...
  'handoff.promptIntro': 'Продолжить из этой локальной папки проекта Z-Design:',
  ...
  'pluginsHome.subtitle': 'Готовые рабочие процессы Z-Design, входящие в состав этой среды выполнения. Выберите один, чтобы загрузить стартовый запрос, или просмотрите реестр для дополнительных вариантов.',
  ...
  'pluginsHome.emptyCatalog': 'Каталог пуст. Встроенные плагины поставляются вместе с Z-Design и должны появляться здесь автоматически — если проблема не исчезает, попробуйте перезапустить демон.',
  ...
  'pluginCard.contributeAria': 'Внести {title} в Z-Design',
  'pluginCard.contributeTitle': 'Внести плагин в Z-Design через pull request',
  ...
  'integrations.lede': 'Подключайте внешние системы, добавляйте инструменты MCP в цикл работы вашего агента и используйте Z-Design из других IDE, скриптов и средств автоматизации.',
  ...
  'mcpClient.daemonError': 'Не удалось подключиться к локальному демону. Убедитесь, что Z-Design запущен, затем снова откройте эту панель.',
  'mcpClient.saveFailed': 'Не удалось сохранить. Убедитесь, что демон запущен, и повторите попытку.',
  'useEverywhere.modalAria': 'Используйте Z-Design везде',
  'useEverywhere.modalTitle': 'Используйте Z-Design везде',
  'useEverywhere.modalSubtitle': 'Подключайте Z-Design к любой IDE, агенту или скрипту — CLI, HTTP, MCP и Skills. Используйте «Copy guide for an agent» и вставьте в Claude Code, Codex, Cursor, openclaw или hermes, чтобы настроить всё.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — готовые к использованию пакеты `SKILL.md` (совместимые с Claude), которые любой агент, уже находящийся в вашем PATH, может вызвать вообще без Z-Design.',
  ...
  'useEverywhere.section.overview.footer': 'По умолчанию демон пишет в `./.od/` (локально для проекта). Установите `ZD_DATA_DIR=~/.open-design`, чтобы использовать общие данные между проектами.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Управляйте Z-Design из любой оболочки',
  ...
  'useEverywhere.section.mcp.heading': 'Предоставьте Z-Design как сервер MCP любому кодовому Agent',
  'useEverywhere.section.mcp.intro': 'Z-Design поставляется с сервером Model Context Protocol (`od mcp`), который позволяет любому клиенту с поддержкой MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — обнаруживать инструменты Z-Design (получать список навыков, отображать предпросмотры, генерировать медиа, запускать плагины) без ручного вызова через shell. Демон публикует готовый к вставке фрагмент установки через `GET /api/mcp/install-info` для каждого основного клиента.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Закрепляет `ZD_DATA_DIR`, чтобы порождённый процесс MCP писал туда же, куда уже пишет демон (позволяет избежать EPERM в упакованных бандлах приложений macOS).',
  ...
  'useEverywhere.section.mcp.footer': 'В приложении Z-Design откройте Settings → Integrations, чтобы скопировать команду установки для конкретного клиента (Cursor, Claude Code, Antigravity, VS Code) вместо ручного редактирования JSON.',
  ...
  'useEverywhere.section.http.intro': 'Локальный демон предоставляет HTTP API по адресу `http://127.0.0.1:7456` (порт настраивается). Любая конечная точка, которую вызывает веб-интерфейс, доступна и для ваших скриптов. Потоковые конечные точки (ходы чата, запуски проектов) отправляют события Server-Sent Events с типами контракта из `@z-design/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Чистые типы TypeScript для каждого запроса/ответа находятся в `@z-design/contracts` — импортируйте их в свой скрипт для полного автодополнения без настройки генератора.',
  'useEverywhere.section.skills.tab': 'Навыки и фоновый режим',
  'useEverywhere.section.skills.heading': 'Готовые к использованию Skills для любого агента — даже без запущенного Z-Design',
  'useEverywhere.section.skills.intro': 'Skill — это директория с совместимым с Claude файлом `SKILL.md` (YAML-фронтматтер + тело). Z-Design расширяет формат пространством имён `od:` (`mode`, `preview`, `design_system`, `inputs`, …), чтобы один и тот же артефакт можно было использовать как внутри Z-Design, так и обычным агентом, например Claude Code, Codex, openclaw или hermes. Обнаружение следует цепочке приоритетов, поэтому проекты могут переопределять свои собственные навыки.',
  ...
  'useEverywhere.section.skills.snippet1': 'Минимальный SKILL.md (совместимый с Claude front matter + дополнения Z-Design)',
  ...
  'entry.githubStarAria': 'Поставить Z-Design звезду на GitHub',
  ...
  'newproj.locationDefault': 'Проекты Z-Design',
  ...
  'socialShare.zDesignSection': 'Поделиться Z-Design',
  'socialShare.zDesignTitle': 'Z-Design на GitHub',
  'socialShare.zDesignText': 'Z-Design — это рабочее пространство с открытым исходным кодом для создания, редактирования, развёртывания и передачи дизайн-артефактов.',
  ...
  'socialShare.projectText': 'Создано с помощью Z-Design: {title}. Посмотрите развёрнутый артефакт и поставьте звезду репозиторию: {repo}',
  'socialShare.projectCopyText': 'Создано с помощью Z-Design: {title}\n{url}\nРепозиторий Z-Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Попросите Z-Design изменить {file}...',
  ...
  'chat.mode.design.solves': 'Используйте его, когда Z-Design должен сгенерировать файлы, обновить workspace или превратить бриф в мультимодальные deliverables.',
  ...
  'preview.shareTextDefault': 'Шаблон Z-Design: {title}',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Z-Design запущен, и повторите попытку.',
  ...
  'designFiles.usefulInfoTip7': 'Нравится Z-Design? Поставьте звезду на GitHub.',
  ...
  'assistant.shareToZDesign': 'Поделиться в Z-Design',
  'assistant.shareToZDesignBusy': 'Готовим пакет…',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Z-Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Z-Design — загрузка не нужна.',
  ...
  'settings.projectLocationsDescription': 'Добавьте рабочие базы, которые могут содержать несколько папок проектов Z-Design. Новые проекты сохраняются как папка внутри выбранной базы.',
  ...
  'settings.customInstructionsHint': 'Постоянные инструкции, которым Z-Design должен следовать в каждом чате. Сохраняйте факты, предпочтения и контекст проекта в виде памяти.',
  ...
  'settings.memoryStarterProjectDesc': 'Z-Design v0.5 — редактор дизайна с управлением через чат',
  ...
  'updater.availableBody': 'Z-Design {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. Z-Design закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть Z-Design',
  'updater.quitFailedBody': 'Установщик открыт, но Z-Design не удалось закрыть. Закройте Z-Design перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. Z-Design закроется и откроет установщик.',
  'updater.readyVersion': 'Z-Design {version} готов. Z-Design закроется и откроет установщик.',
  ...
  'dsManager.createBody': 'Обучите Z-Design вашему бренду, продукту, коду, ресурсам и дизайн-референсам.',
  ...
  'settings.customInstructionsDesc': 'Фиксированные инструкции, которым Z-Design следует в каждом чате. Это не сохранённые воспоминания; используйте Память для фактов, предпочтений и контекста проекта.',
