...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Z-Design\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.onboardingCreateBody': 'İstediğiniz siteyi, uygulamayı, sunumu, görseli veya videoyu tanımlayın. Z-Design bir proje oluşturacak ve çalışmayı düzenlenebilir tutacak.',
  ...
  'settings.onboardingGateTooltipAmr': 'Sonraki adımlar yapay zekâ ile çalışır — devam etmek için Z-Design AMR’ye giriş yapın.',
  ...
  'settings.agentInstall.pathHint': 'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Z-Design daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth': 'Z-Design\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'Z-Design\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'settings.privacyHint': 'Z-Design ekibiyle hangi veriler paylaşılır',
  'settings.privacyConsentKicker': 'Z-Design\'ı geliştirmemize yardımcı olun',
  'settings.privacyConsentLead': 'Z-Design, geliştirmemize yardımcı olmak için kullanım verilerini ekibimizle paylaşabilir. Buna şunlar dahildir:',
  ...
  'settings.mcpHint': 'Kodlama agent\'larının (Cursor, Claude Code, VS Code…) Z-Design projelerinizi doğrudan okumasına izin verin.',
  'settings.mcpDaemonError': 'Kurulum yollarını çözümlemek için yerel daemon\'a ulaşılamadı ({error}). Z-Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'settings.mcpBuildDaemon': 'Önce daemon\'ı derleyin.',
  'settings.mcpNodeMissing': 'Node ikili dosyası eksik.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js eksik. `pnpm --filter @z-design/daemon build` komutunu çalıştırın ve yenileyin.',
  ...
  'settings.mcpCapabilityDefault': 'Z-Design\'da açık olan projeyi ve dosyayı varsayılan olarak kullanın; böylece hangi tasarım olduğunu yeniden belirtmeden "bunu uygulamamda oluştur" diyebilirsiniz.',
  'settings.mcpRunningNote': 'MCP araç çağrılarının başarılı olması için Z-Design\'ın çalışıyor olması gerekir. Kodlama agent\'ınızı Z-Design\'ı açmadan önce başlattıysanız, canlı daemon\'a ulaşabilmesi için agent\'ı yeniden başlatın.',
  ...
  'entry.discordAria': 'Z-Design Discord\'una katılın',
  'entry.discordAriaWithOnline': 'Z-Design Discord\'una katılın - {online}',
  ...
  'homeHero.subtitlePrefix': 'GLM-natif ajan tabanlı tasarım çalışma alanı.',
  ...
  'homeHero.chip.createPluginHint': 'Yeniden kullanılabilir bir Z-Design plugin\'i oluşturun ve Plugin\'lerim\'e ekleyin.',
  ...
  'handoff.promptIntro': 'Bu yerel Z-Design proje klasöründen devam edin:',
  ...
  'pluginsHome.subtitle': 'Bu çalışma zamanıyla birlikte gelen, kullanıma hazır Z-Design iş akışları. Başlangıç istemi yüklemek için birini seçin veya daha fazlası için kayıt defterine göz atın.',
  ...
  'pluginsHome.emptyCatalog': 'Katalog boş. Paketlenmiş eklentiler Z-Design ile birlikte gelir ve buraya otomatik olarak görünmelidir — bu durum devam ederse daemon\'u yeniden başlatmayı deneyin.',
  ...
  'pluginCard.contributeAria': '{title} öğesini Z-Design\'a katkı olarak ekle',
  'pluginCard.contributeTitle': 'Plugin\'i pull request ile Z-Design\'a katkı olarak ekle',
  ...
  'integrations.lede': 'Harici sistemleri bağlayın, MCP araçlarını agent döngünüze dahil edin ve Z-Design\'ı diğer IDE\'ler, betikler ve otomasyonlardan kullanın.',
  ...
  'mcpClient.daemonError': 'Yerel daemon\'a ulaşılamadı. Z-Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'mcpClient.saveFailed': 'Kaydetme başarısız oldu. Daemon\'ın çalıştığını kontrol edip tekrar deneyin.',
  'useEverywhere.modalAria': 'Z-Design\'ı her yerde kullanın',
  'useEverywhere.modalTitle': 'Z-Design\'ı her yerde kullanın',
  'useEverywhere.modalSubtitle': 'Z-Design\'ı herhangi bir IDE\'ye, Agent\'a veya betiğe bırakın — CLI, HTTP, MCP ve Beceriler. Her şeyi kurmak için "Bir agent için kılavuzu kopyala"yı kullanın ve Claude Code, Codex, Cursor, openclaw veya hermes\'e yapıştırın.',
  ...
  'useEverywhere.section.overview.heading': 'Z-Design, agent\'ınızın çalıştığı her yerde çalışır',
  'useEverywhere.section.overview.intro': 'Z-Design bir pencereden fazlasıdır — yerel ayrıcalıklı bir daemon (`od`) ile birlikte bir Beceriler + Tasarım Sistemleri + Atoms kayıt defteridir. Makinenizde çalışmaya başladığında, herhangi bir kod agent\'ı (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, kendi betiğiniz) dört değiştirilebilir yüzey aracılığıyla üretimleri yönetebilir, projeleri inceleyebilir ve tasarım çıktıları üretebilir.',
  'useEverywhere.section.overview.bullet1': 'CLI — başsız betikler, CI ve kabuk otomasyonu için `od <command>`.',
  'useEverywhere.section.overview.bullet2': 'MCP sunucusu — Z-Design\'ı bir Model Context Protocol sunucusu olarak bağlar, böylece MCP destekli herhangi bir agent becerileri listeleyebilir, senaryoları çalıştırabilir ve çıktıları okuyabilir.',
  ...
  'useEverywhere.section.overview.bullet4': 'Beceriler — PATH\'inizde zaten bulunan herhangi bir agent\'ın Z-Design olmadan çağırabileceği eklenebilir `SKILL.md` paketleri (Claude uyumlu).',
  ...
  'useEverywhere.section.overview.footer': 'Daemon varsayılan olarak `./.od/` dizinine (proje-yerel) yazar. Verileri projeler arasında paylaşmak için `ZD_DATA_DIR=~/.open-design` ayarlayın.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Z-Design\'ı herhangi bir kabuktan yönetin',
  ...
  'useEverywhere.section.mcp.heading': 'Z-Design\'ı herhangi bir kodlama agent\'ına MCP sunucusu olarak sun',
  'useEverywhere.section.mcp.intro': 'Z-Design, MCP destekli herhangi bir istemcinin — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — Z-Design araçlarını (becerileri listele, önizlemeleri oluştur, medya üret, eklentileri çalıştır) manuel olarak kabuk açmadan keşfetmesini sağlayan bir Model Context Protocol sunucusu (`od mcp`) ile gelir. Daemon, her büyük istemci için `GET /api/mcp/install-info` aracılığıyla yapıştırmaya hazır bir kurulum parçacığı yayınlar.',
  ...
  'useEverywhere.section.mcp.bullet4': '`ZD_DATA_DIR` değerini sabitler, böylece oluşturulan MCP süreci daemon\'ın zaten kullandığı yere yazar (paketlenmiş macOS uygulama paketlerinde EPERM\'i önler).',
  ...
  'useEverywhere.section.mcp.footer': 'Z-Design uygulamasında, JSON\'u elle düzenlemek yerine istemciye özel bir kurulum komutu (Cursor, Claude Code, Antigravity, VS Code) kopyalamak için Ayarlar → Entegrasyonlar\'ı açın.',
  ...
  'useEverywhere.section.http.footer': 'Her istek/yanıt için saf TypeScript türleri `@z-design/contracts` içinde bulunur — bir oluşturucu bağlamadan tam otomatik tamamlama için bunları betiğinize aktarın.',
  'useEverywhere.section.skills.tab': 'Skill\'ler ve başsız',
  'useEverywhere.section.skills.heading': 'Herhangi bir agent için eklenebilir Beceriler — Z-Design çalışmıyor olsa bile',
  'useEverywhere.section.skills.intro': 'Bir Beceri, Claude uyumlu bir `SKILL.md` (YAML ön bilgisi + gövde) içeren bir dizindir. Z-Design, formatı `od:` ad alanıyla (`mode`, `preview`, `design_system`, `inputs`, …) genişletir, böylece aynı çıktı hem Z-Design içinde hem de Claude Code, Codex, openclaw veya hermes gibi sade bir agent tarafından kullanılabilir. Keşif, projelerin kendi becerilerini geçersiz kılabilmesi için bir öncelik zincirini izler.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude uyumlu ön bilgi + Z-Design ekstraları)',
  ...
  'entry.githubStarAria': 'Z-Design’a GitHub üzerinde yıldız ver',
  ...
  'newproj.locationDefault': 'Z-Design projeleri',
  ...
  'socialShare.zDesignSection': 'Z-Design\'ı paylaş',
  'socialShare.zDesignTitle': 'GitHub\'da Z-Design',
  'socialShare.zDesignText': 'Z-Design; tasarım yapıtları oluşturmak, düzenlemek, dağıtmak ve devretmek için açık kaynaklı bir çalışma alanıdır.',
  ...
  'socialShare.projectText': 'Z-Design ile oluşturuldu: {title}. Dağıtılan yapıtı görüntüleyin ve depoya yıldız verin: {repo}',
  'socialShare.projectCopyText': 'Z-Design ile oluşturuldu: {title}\n{url}\nZ-Design deposu: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Z-Design\'dan {file} dosyasını değiştirmesini isteyin...',
  ...
  'chat.mode.design.solves': 'Z-Design’ın dosya üretmesini, workspace’i güncellemesini veya brief’i çok modlu deliverable’lara dönüştürmesini istediğinizde kullanın.',
  ...
  'preview.shareTextDefault': 'Z-Design şablonu: {title}',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Z-Design\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'assistant.shareToZDesign': 'Z-Design\'a paylaş',
  'assistant.shareToZDesignBusy': 'Paket hazırlanıyor…',
  ...
  'pet.tabBuiltInHint': 'Z-Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Z-Design ile birlikte gelir — indirme gerekmez.',
  ...
  'settings.projectLocationsDescription': 'Birden fazla Z-Design proje klasörü içerebilen çalışma tabanları ekleyin. Yeni projeler seçilen tabanın içinde bir klasör olarak kaydedilir.',
  ...
  'settings.customInstructionsHint': 'ZDesign\'ın her sohbette uyması gereken sabit talimatlar. Gerçekleri, tercihleri ve proje bağlamını bellek olarak kaydedin.',
  ...
  'settings.memoryStarterProjectDesc': 'Z-Design v0.5 — sohbet odaklı tasarım editörü',
  ...
  'updater.availableBody': 'Z-Design {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için Z-Design kapatılıyor.',
  ...
  'updater.quitButton': 'Z-Design’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak Z-Design kapatılamadı. Uygulamayı değiştirmeden önce Z-Design’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. Z-Design kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'Z-Design {version} hazır. Z-Design kapanıp yükleyiciyi açacak.',
  ...
  'dsManager.createBody': 'Z-Design\'a markanızı, ürününüzü, kodunuzu, varlıklarınızı ve tasarım referanslarınızı öğretin.',
  ...
  'settings.customInstructionsDesc': 'Z-Design\'ın her sohbette izlediği sabit yönergeler. Bunlar kayıtlı bellekler değildir; gerçekler, tercihler ve proje bağlamı için Bellek\'i kullanın.',
