...
export interface Dict {
  ...
  'socialShare.zDesignSection': string;
  'socialShare.zDesignTitle': string;
  'socialShare.zDesignText': string;
  'socialShare.zDesignCopyText': string;
  ...
  'assistant.shareToZDesign': string;
  'assistant.shareToZDesignBusy': string;
