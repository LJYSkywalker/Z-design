...
import type { InstalledPluginRecord, PluginSourceKind, TrustTier } from '@z-design/contracts';
...
describe('PluginsView', () => {
  ...
  it('uploads zip and folder plugins from the import dialog', async () => {
    ...
    const folderFile = new File(['{}'], 'z-design.json', { type: 'application/json' });
