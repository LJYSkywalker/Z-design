...
vi.mock('@z-design/host', async () => {
  const actual = await vi.importActual<typeof import('@z-design/host')>('@z-design/host');
  return {
    ...actual,
    isZDesignHostAvailable: vi.fn(),
...
const mockedIsHostAvailable = vi.mocked(isZDesignHostAvailable);
