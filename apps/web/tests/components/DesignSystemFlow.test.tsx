...
describe('DesignSystemCreationFlow', () => {
  ...
  it('allows GitHub repo links without Composio by using local GitHub intake', () => {
    ...
    fireEvent.change(input, { target: { value: 'https://github.com/Aqu-210L/Z-design/' } });
  ...
  it('records connected GitHub repository sources in the project source manifest', async () => {
    ...
    expect(mocks.writeProjectTextFile).toHaveBeenCalledWith(
      project.id,
      'context/source-context.md',
      expect.stringContaining('https://github.com/Aqu-210L/Z-design'),
    );
    expect(mocks.writeProjectTextFile).toHaveBeenCalledWith(
      project.id,
      'context/source-context.md',
    ...
    expect(mocks.writeProjectTextFile).toHaveBeenCalledWith(
      project.id,
      'context/source-context.md',
      expect.stringContaining('"$ZD_NODE_BIN" "$ZD_BIN" tools connectors github-design-context --repo \'https://github.com/Aqu-210L/Z-design\' --output context/github/nexu-io-open-design.md'),
    );
