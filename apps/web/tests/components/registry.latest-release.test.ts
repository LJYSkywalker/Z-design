...
import type { ZDesignGithubLatestReleaseResponse } from '@z-design/contracts';
  ...
  it('reads the latest release metadata from the daemon endpoint', async () => {
    globalThis.fetch = vi.fn().mockResolvedValue({
      ...
      json: async () => ({
        ...
        html_url: 'https://github.com/Aqu-210L/Z-design/releases/tag/v0.8.0-nightly.3',
        fetchedAt: Date.parse('2026-05-22T00:00:00.000Z'),
        stale: false,
      } satisfies ZDesignGithubLatestReleaseResponse),
    ...
    expect(result).toEqual({
      ...
      htmlUrl: 'https://github.com/Aqu-210L/Z-design/releases/tag/v0.8.0-nightly.3',
      stale: false,
    });
  });
