...
const LS_KEY = 'z-design:locale';
const LS_SOURCE_KEY = 'z-design:locale-source';
...
// state into the next case (installMockZDesignHost returns an
...
function installHostWithOsLocale(value: unknown): void {
  uninstallHost?.();
  uninstallHost = installMockZDesignHost({
    host: {
