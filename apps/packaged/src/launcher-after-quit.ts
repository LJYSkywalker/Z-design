...
import { waitForProcessExit } from "@z-design/platform";
import type { LauncherAfterQuitRequest } from "@z-design/launcher-proto";
import { APP_KEYS, OPEN_DESIGN_SIDECAR_CONTRACT, SIDECAR_MESSAGES, type DesktopStatusSnapshot } from "@z-design/sidecar-proto";
