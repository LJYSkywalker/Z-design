...
import { SIDECAR_DEFAULTS, normalizeNamespace } from "@z-design/sidecar-proto";
...
export const PACKAGED_CONFIG_PATH_ENV = "ZD_PACKAGED_CONFIG_PATH";
export const PACKAGED_NAMESPACE_ENV = "ZD_PACKAGED_NAMESPACE";
export const PACKAGED_WEB_OUTPUT_MODE_OVERRIDE_ENV = "ZD_PACKAGED_ALLOW_WEB_OUTPUT_MODE_OVERRIDE";
export const PACKAGED_WEB_STANDALONE_ROOT_ENV = "ZD_WEB_STANDALONE_ROOT";
export const PACKAGED_WEB_OUTPUT_MODE_ENV = "ZD_WEB_OUTPUT_MODE";
