...
import type { CritiqueSseEvent } from '@z-design/contracts/critique';
...
// ---------------------------------------------------------------------------
// Config gate: ZD_CRITIQUE_ENABLED=false (legacy path unchanged)
// ---------------------------------------------------------------------------
...
describe('spawn wiring - cfg.enabled=false (M0 default)', () => {
  ...
  it('loadCritiqueConfigFromEnv with ZD_CRITIQUE_ENABLED=false returns enabled=false', () => {
...
// ---------------------------------------------------------------------------
// Config gate: ZD_CRITIQUE_ENABLED=true (orchestrator path)
// ---------------------------------------------------------------------------

describe('spawn wiring - cfg.enabled=true (orchestrator path)', () => {
  it('with ZD_CRITIQUE_ENABLED=true, runOrchestrator is invoked with the spawn stdout', async () => {
