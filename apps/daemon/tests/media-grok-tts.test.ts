...
describe('xAI Grok TTS media generation', () => {
  ...
  const originalGrokKey = process.env.ZD_GROK_API_KEY;
  ...
  beforeEach(async () => {
    ...
    delete process.env.ZD_GROK_API_KEY;
    delete process.env.XAI_API_KEY;
  });

  afterEach(async () => {
    globalThis.fetch = realFetch;
    if (originalMediaConfigDir == null) delete process.env.ZD_MEDIA_CONFIG_DIR;
    else process.env.ZD_MEDIA_CONFIG_DIR = originalMediaConfigDir;
    if (originalDataDir == null) delete process.env.ZD_DATA_DIR;
    else process.env.ZD_DATA_DIR = originalDataDir;
    if (originalGrokKey == null) delete process.env.ZD_GROK_API_KEY;
    else process.env.ZD_GROK_API_KEY = originalGrokKey;
