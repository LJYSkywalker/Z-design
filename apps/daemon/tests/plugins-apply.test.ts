...
import type { ContextItem, InstalledPluginRecord } from '@z-design/contracts';
...
describe('applyPlugin', () => {
  ...
  it('does not require a registry roots argument (no FS access at apply time)', () => {
    ...
    const expectedDataDir = path.resolve(process.env.ZD_DATA_DIR ?? path.join(process.cwd(), '.od'));
