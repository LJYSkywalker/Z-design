...
describe('openrouter video generation', () => {
  ...
  beforeEach(async () => {
    ...
    process.env.ZD_OPENROUTER_API_KEY = 'sk-or-test-key-1234';
  });

  afterEach(async () => {
    globalThis.fetch = realFetch;
    delete process.env.ZD_OPENROUTER_API_KEY;
  ...
  it('honours ZD_MEDIA_MODEL_ALIASES for video (alias contract regression)', async () => {
  ...
  it('defaults the poll ceiling to 30 minutes (timeout contract regression)', async () => {
    // Without ZD_OPENROUTER_VIDEO_MAX_POLL_MS, the default should be 30 min.
    delete process.env.ZD_OPENROUTER_VIDEO_MAX_POLL_MS;
...
describe('openrouter image generation', () => {
  ...
  beforeEach(async () => {
    ...
    delete process.env.ZD_MEDIA_CONFIG_DIR;
    delete process.env.ZD_DATA_DIR;
    process.env.ZD_OPENROUTER_API_KEY = 'sk-or-img-test-key';
  });
  ...
  it('honours ZD_MEDIA_MODEL_ALIASES for image (alias contract regression)', async () => {
