...
//
// Two contracts:
//   1. The Zod schema in @z-design/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@z-design/contracts';
import { validateSafe } from '@z-design/plugin-runtime';
