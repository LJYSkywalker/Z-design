...
const originalDisablePlugins = process.env.ZD_CODEX_DISABLE_PLUGINS;
const originalPath = process.env.PATH;
const originalHome = process.env.HOME;
const originalAgentHome = process.env.ZD_AGENT_HOME;
const originalDaemonUrl = process.env.ZD_DAEMON_URL;
const originalToolToken = process.env.ZD_TOOL_TOKEN;
...
afterEach(() => {
  if (originalDisablePlugins == null) {
    delete process.env.ZD_CODEX_DISABLE_PLUGINS;
  } else {
    process.env.ZD_CODEX_DISABLE_PLUGINS = originalDisablePlugins;
  }
  ...
  if (originalDaemonUrl == null) {
    delete process.env.ZD_DAEMON_URL;
  } else {
    process.env.ZD_DAEMON_URL = originalDaemonUrl;
  }
  if (originalToolToken == null) {
    delete process.env.ZD_TOOL_TOKEN;
  } else {
    process.env.ZD_TOOL_TOKEN = originalToolToken;
  }
