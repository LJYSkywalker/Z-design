...
> = {
  ...
  amr: {
    ...
    docsUrl: 'https://github.com/Aqu-210L/Z-design/blob/main/docs/new-agent-runtime-acp.md',
  },
  claude: {
  ...
  hermes: {
    installUrl: 'https://github.com/Aqu-210L/Z-design/blob/main/docs/agent-adapters.md',
