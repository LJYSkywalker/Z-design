...
import type { CritiqueConfig, PanelEvent } from '@z-design/contracts/critique';
import { panelEventToSse } from '@z-design/contracts/critique';
...
const tracer = trace.getTracer('@z-design/daemon/critique');
