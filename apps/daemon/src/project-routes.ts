...
export function registerProjectRoutes(app: Express, ctx: RegisterProjectRoutesDeps) {
  ...
  app.get('/api/project-locations', async (_req, res) => {
    try {
      const locations = await configuredProjectLocations();
      /** @type {import('@z-design/contracts').ProjectLocationsResponse} */
  ...
  app.post('/api/project-locations/scan', async (_req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ScanProjectLocationsResponse} */
  ...
  app.get('/api/projects', async (_req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ProjectsResponse} */
      const body = {
  ...
  app.post('/api/projects', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').CreateProjectResponse} */
      const body = {
  ...
  app.get('/api/projects/:id', async (req, res) => {
    ...
    /** @type {import('@z-design/contracts').ProjectResponse} */
...
export function registerProjectFileRoutes(app: Express, ctx: RegisterProjectFileRoutesDeps) {
  ...
  app.get('/api/projects/:id/files', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ProjectFilesResponse} */
      const body = { files };
      res.json(body);
    } catch (err: any) {
      sendApiError(res, 400, 'BAD_REQUEST', String(err));
  ...
  app.get('/api/projects/:id/folders', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ProjectFoldersResponse} */
      const body = { folders };
      res.json(body);
    } catch (err: any) {
      sendApiError(res, 400, 'BAD_REQUEST', String(err));
  ...
  app.post('/api/projects/:id/folders', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ProjectFolderResponse} */
      const body = { folder };
      res.json(body);
    } catch (err: any) {
  ...
  app.delete('/api/projects/:id/folders', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').DeleteProjectFolderResponse} */
      const body = { ok: true };
      res.json(body);
    } catch (err: any) {
      sendApiError(res, 400, 'BAD_REQUEST', String(err?.message || err));
  ...
  app.get('/api/projects/:id/preview-url', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').ProjectPreviewUrlResponse} */
      const body = {
  ...
  app.delete(/^\/api\/projects\/([^/]+)\/raw\/(.+)$/u, async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').DeleteProjectFileResponse} */
      const body = { ok: true };
      res.json(body);
    } catch (err: any) {
      const status = err && err.code === 'ENOENT' ? 404 : 400;
    ...
    async (req, res) => {
      try {
        ...
        if (req.file) {
          ...
          /** @type {import('@z-design/contracts').ProjectFileResponse} */
  ...
  app.post('/api/projects/:id/files/rename', async (req, res) => {
    try {
      ...
      /** @type {import('@z-design/contracts').RenameProjectFileResponse} */
      const body = result;
      res.json(body);
    } catch (err: any) {
      if (err?.code === 'EEXIST') {
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        /** @type {import('@z-design/contracts').UploadProjectFilesResponse} */
