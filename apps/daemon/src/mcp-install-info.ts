...
// ELECTRON_RUN_AS_NODE env read, ZD_DATA_DIR resolution, sidecar IPC
// detection) all stay in the caller. This module is intentionally pure
// and free of @z-design/sidecar-proto so it can be unit-tested
...
export function buildMcpInstallPayload(
  ...
  // Pin ZD_DATA_DIR to the daemon's resolved data root so the spawned
