...
import { OPEN_DESIGN_PLUGIN_SPEC_VERSION } from '@z-design/contracts';
...
export async function generateSkillPluginDraft(
  ...
  await fs.writeFile(path.join(folder, 'z-design.json'), JSON.stringify(buildManifest(slug, candidate), null, 2) + '\n', 'utf8');
