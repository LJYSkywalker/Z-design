...
//
//   - Validates the manifest using @z-design/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@z-design/plugin-runtime';
import type { InstalledPluginRecord, PluginManifest } from '@z-design/contracts';
