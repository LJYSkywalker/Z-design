...
//
//   - `od`            → SKILL.md + z-design.json (canonical OD shape).
...
// installed plugin's fs_path, and reconstructs z-design.json from
...
import type { AppliedPluginSnapshot } from '@z-design/contracts';
