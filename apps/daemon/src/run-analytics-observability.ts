import type { TrackingRuntimeType } from '@z-design/contracts/analytics';
...
// GLM is the sole agent; AMR account-id stamping is no longer applicable.
// Kept as a no-op export because server.ts still calls it unconditionally.
