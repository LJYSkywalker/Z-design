...
export const DESKTOP_UPDATE_ENV = Object.freeze({
  ARCH: "ZD_UPDATE_ARCH",
  AUTO_CHECK: "ZD_UPDATE_AUTO_CHECK",
  AUTO_DOWNLOAD: "ZD_UPDATE_AUTO_DOWNLOAD",
  AUTO_OPEN: "ZD_UPDATE_AUTO_OPEN",
  CHECK_BACKOFF_INITIAL_MS: "ZD_UPDATE_CHECK_BACKOFF_INITIAL_MS",
  CHECK_BACKOFF_MAX_MS: "ZD_UPDATE_CHECK_BACKOFF_MAX_MS",
  CHECK_INITIAL_DELAY_MS: "ZD_UPDATE_CHECK_INITIAL_DELAY_MS",
  CHECK_INTERVAL_MS: "ZD_UPDATE_CHECK_INTERVAL_MS",
  CHANNEL: "ZD_UPDATE_CHANNEL",
  CURRENT_VERSION: "ZD_UPDATE_CURRENT_VERSION",
  DOWNLOAD_ROOT: "ZD_UPDATE_DOWNLOAD_ROOT",
  ENABLED: "ZD_UPDATE_ENABLED",
  METADATA_URL: "ZD_UPDATE_METADATA_URL",
  MODE: "ZD_UPDATE_MODE",
  OPEN_DRY_RUN: "ZD_UPDATE_OPEN_DRY_RUN",
  PLATFORM: "ZD_UPDATE_PLATFORM",
} as const);
