...
```bash
pnpm --filter @z-design/contracts typecheck
pnpm --filter @z-design/host typecheck
pnpm --filter @z-design/host test
pnpm --filter @z-design/metatool typecheck
pnpm --filter @z-design/metatool test
pnpm --filter @z-design/sidecar-proto typecheck
pnpm --filter @z-design/sidecar-proto test
pnpm --filter @z-design/sidecar typecheck
pnpm --filter @z-design/sidecar test
pnpm --filter @z-design/platform typecheck
pnpm --filter @z-design/platform test
```
