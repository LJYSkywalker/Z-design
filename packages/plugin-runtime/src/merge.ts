import type { PluginManifest } from '@z-design/contracts';

// Merge a sidecar `z-design.json` PluginManifest with one or more adapter
// outputs. `z-design.json` always wins (spec §5.4); adapter values fill
