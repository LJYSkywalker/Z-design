...
export const SIDECAR_ENV = Object.freeze({
  BASE: "ZD_SIDECAR_BASE",
  DAEMON_CLI_PATH: "ZD_DAEMON_CLI_PATH",
  DAEMON_PORT: "ZD_PORT",
  IPC_BASE: "ZD_SIDECAR_IPC_BASE",
  IPC_PATH: "ZD_SIDECAR_IPC_PATH",
  NAMESPACE: "ZD_SIDECAR_NAMESPACE",
  SOURCE: "ZD_SIDECAR_SOURCE",
  TOOLS_DEV_PARENT_PID: "ZD_TOOLS_DEV_PARENT_PID",
  WEB_DIST_DIR: "ZD_WEB_DIST_DIR",
  WEB_PORT: "ZD_WEB_PORT",
  WEB_TSCONFIG_PATH: "ZD_WEB_TSCONFIG_PATH",
} as const);
...
export type DaemonStatusSnapshot = {
   ...
   * was spawned without `ZD_REQUIRE_DESKTOP_AUTH=1` (the split-start
...
export type ZDesignSidecarContract = {
...
} as const satisfies ZDesignSidecarContract);
