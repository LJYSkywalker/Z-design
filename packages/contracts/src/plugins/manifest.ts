...
// `z-design.json` schema (v1). Mirrors docs/schemas/open-design.plugin.v1.json
...
export const ZDesignSpecVersionSchema = z.string().min(1);
...
export const PluginManifestSchema = z.object({
  ...
  specVersion: ZDesignSpecVersionSchema.optional(),
