...
describe('@z-design/contracts package runtime shape', () => {
  ...
  it('makes runtime exports importable through package exports', async () => {
    const contracts = await import('@z-design/contracts');
    const connectionTest = await import('@z-design/contracts/api/connectionTest');
    const research = await import('@z-design/contracts/api/research');
    const handoff = await import('@z-design/contracts/api/handoff');
    const critique = await import('@z-design/contracts/critique');
