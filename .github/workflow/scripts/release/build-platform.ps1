...
try {
  ...
  if ($SmokeMode -eq "skip") {
    ...
    $previous = @{
      ZD_PACKAGED_E2E_BUILD_JSON_PATH = $env:ZD_PACKAGED_E2E_BUILD_JSON_PATH
      ZD_PACKAGED_E2E_WIN = $env:ZD_PACKAGED_E2E_WIN
      ZD_PACKAGED_E2E_WIN_SMOKE_PROFILE = $env:ZD_PACKAGED_E2E_WIN_SMOKE_PROFILE
      ZD_PACKAGED_E2E_NAMESPACE = $env:ZD_PACKAGED_E2E_NAMESPACE
      ZD_PACKAGED_E2E_RELEASE_CHANNEL = $env:ZD_PACKAGED_E2E_RELEASE_CHANNEL
      ZD_PACKAGED_E2E_RELEASE_VERSION = $env:ZD_PACKAGED_E2E_RELEASE_VERSION
      ZD_PACKAGED_E2E_REPORT_DIR = $env:ZD_PACKAGED_E2E_REPORT_DIR
      ZD_PACKAGED_E2E_TOOLS_PACK_DIR = $env:ZD_PACKAGED_E2E_TOOLS_PACK_DIR
      ZD_PACKAGED_E2E_WIN_UPDATE_ARTIFACT_PATH = $env:ZD_PACKAGED_E2E_WIN_UPDATE_ARTIFACT_PATH
      ZD_PACKAGED_E2E_WIN_UPDATE_VERSION = $env:ZD_PACKAGED_E2E_WIN_UPDATE_VERSION
      ZD_PACKAGED_E2E_WIN_UPDATE_BUILD_JSON_PATH = $env:ZD_PACKAGED_E2E_WIN_UPDATE_BUILD_JSON_PATH
    }
    try {
      ...
      if (-not [string]::IsNullOrWhiteSpace($localUpdateArtifactPath)) {
        ...
        $env:ZD_PACKAGED_E2E_WIN_UPDATE_BUILD_JSON_PATH = Join-Path $WorkRoot "windows-tools-pack-update-build.json"
      }
