...
If you're not sure which bucket your idea is in, [open a discussion / issue first](https://github.com/Aqu-210L/Z-design/issues/new) and we'll point you at the right surface.
...
- Architecture question, design question, "is this a bug or a misuse" → [GitHub Discussions](https://github.com/Aqu-210L/Z-design/discussions) (preferred — searchable for the next person).
